...
$(function () {
  ...
  window.ckeditorLoad = function() {
  $('#ckeditor1,.ckeditor1').each(function() {
    if (this.style.display == 'none') return;

    ClassicEditor.create(this, {
      removePlugins: [ 'Title', 'Markdown', 'CKFinder', 'CKFinderUploadAdapter' ],
      toolbar: {
        items: [
          'heading',
          '|',
      ...
      simpleUpload: {
        uploadUrl: base_url + '/upload/ckeditor',
      },
      image: {
        toolbar: [
