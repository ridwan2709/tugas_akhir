...
$no_serial = $this->db->get_where('enroll', ['student_id' => $student_id, 'year' => $running_year])->row()->no_serial;
?>
                ...
                <div class="rcard-wy" id="print_area">
                    <div class="rcard-w" style="padding-top: 30px;">
                        ...
                        <div class="rcard-heading">
                            ...
                            <h5>Tahun Ajaran <?php echo $this->db->get_where('settings', array('type' => 'running_year'))->row()->description; ?></h5>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    foreach ($subjects as $row3) :
                                        $mark = $this->db->get_where('mark', array(
                                            'student_id' => $student_id, 'subject_id' => $row3['subject_id'], 'class_id' => $class_id, 'exam_id' => $exam_id,
