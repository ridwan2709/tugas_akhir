...
$title = $this->db->get_where('settings', array('type' => 'system_title'))->row()->description;
...
<body>
    ...
    <div class="form-body without-side" id="login">
        <div class="row">
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <br>
                        <h5 style="text-align: center"><?php echo get_phrase('login_to_your_account'); ?></h5><br>
                        <?php if ($this->session->userdata('error') == '1') : ?>
                            <div class="form-login-error">
                                <center>
                                    <div class="alert alert-danger"><?php echo get_phrase('login_error'); ?></div>
                                </center>
                            </div>
                        <?php endif; ?>
