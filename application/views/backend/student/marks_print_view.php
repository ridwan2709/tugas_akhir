                        ...
                        <div class="infos">
                            ...
                            <div class="info-2">
                                ...
                                <div class="company-address">
                                    <?php echo get_phrase('roll'); ?>: <?php echo $this->db->get_where('enroll', array('student_id' => $this->session->userdata('login_user_id')))->row()->roll; ?><br />Kelas: <?php echo $this->db->get_where('class', array('class_id' => $class_id))->row()->name; ?><br />Kelompok: <?php echo $this->db->get_where('section', array('class_id' => $class_id))->row()->name; ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    foreach ($subjects as $row3) :
                                        $mark = $this->db->get_where('mark', array(
                                            'student_id' => $this->session->userdata('login_user_id'), 'subject_id' => $row3['subject_id'], 'class_id' => $class_id, 'exam_id' => $exam_id,
                                            'year' => $tahun_ajaran
                                        ));
                                        if ($mark->num_rows() > 0) {
