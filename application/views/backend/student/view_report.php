              ...
              <div class="ui-block paddingtel lined-danger">
                ...
                <div class="ui-block-content">
                  <div class="widget w-about" style="text-align:center">
                    <a href="javascript:void(0);" class="logo"><img src="<?php echo $this->crud_model->get_image_url('teacher', $row['teacher_id']); ?>" alt="Educaby" class="purple" style="border-radius: 50%; width:90px;"></a>
  ...
  $(document).ready(function() {
    $("#add").click(function() {
      ...
      if (report_code != "" && message != "") {
        $.ajax({
          url: "<?php echo base_url(); ?>student/create_report_message/",
          type: 'POST',
          data: {
            message: message,
