                    ...
                    <div class="tab-content">
                        <div class="os-tabs-w bg-white">
                            <ul class="navs navs-tabs upper centered">
                                <li class="navs-item">
                                    <a class="navs-links <?php if ($page_name == 'message' && $message_inner_page_name != 'message_new'); ?>" href="<?php echo base_url(); ?>student/message/" style="color:#000"><i class="os-icon picons-thin-icon-thin-0306_chat_message_discussion_bubble_conversation" style="color:#047bf8"></i><span><?php echo get_phrase('chats'); ?></span></a>
                                </li>
                                <li class="navs-item">
                                ...
                                <li class="navs-item">
                                    <a class="navs-links <?php if ($page_name == 'group') echo "active"; ?>" href="<?php echo base_url(); ?>student/group/" style="color:#000"><i class="os-icon picons-thin-icon-thin-0719_group_users_circle" style="color:#047bf8"></i><span><?php echo get_phrase('groups'); ?></span></a>
                                </li>
                            </ul>
                        </div>
