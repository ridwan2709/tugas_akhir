<div class="full-chat-middle">
  <div class="chat-head">
    ...
    <div class="user-info">
      ...
      <a class="btn btn-success btn-sm" href="#" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/group_info/<?php echo $current_message_thread_code; ?>');"><?php echo get_phrase('group_members'); ?></a>
    </div>
  </div>
          ...
          <div class="chat-message">
            ...
            <div class="chat-message-date">
              ...
              <?php elseif ($sender_account_type == 'teacher') : ?>
                <span class="badge badge-success"><?php echo $this->db->get_where($sender_account_type, array($sender_account_type . '_id' => $sender_id))->row()->first_name . " " . $this->db->get_where($sender_account_type, array($sender_account_type . '_id' => $sender_id))->row()->last_name; ?></span>
              <?php elseif ($sender_account_type == 'student') : ?>
                <span class="badge badge-warning"><?php echo $this->db->get_where($sender_account_type, array($sender_account_type . '_id' => $sender_id))->row()->first_name . " " . $this->db->get_where($sender_account_type, array($sender_account_type . '_id' => $sender_id))->row()->last_name; ?></span>
              <?php elseif ($sender_account_type == 'parent') : ?>
                <span class="badge badge-danger"><?php echo $this->db->get_where($sender_account_type, array($sender_account_type . '_id' => $sender_id))->row()->first_name . " " . $this->db->get_where($sender_account_type, array($sender_account_type . '_id' => $sender_id))->row()->last_name; ?></span>
              <?php elseif ($sender_account_type == 'accountant') : ?>
                <span class="badge badge-purple"><?php echo $this->db->get_where($sender_account_type, array($sender_account_type . '_id' => $sender_id))->row()->first_name . " " . $this->db->get_where($sender_account_type, array($sender_account_type . '_id' => $sender_id))->row()->last_name; ?></span>
              <?php elseif ($sender_account_type == 'librarian') : ?>
                <span class="badge badge-info"><?php echo $this->db->get_where($sender_account_type, array($sender_account_type . '_id' => $sender_id))->row()->first_name . " " . $this->db->get_where($sender_account_type, array($sender_account_type . '_id' => $sender_id))->row()->last_name; ?></span>
              <?php endif; ?>
              <br>
  ...
  <div class="chat-info-section">
    ...
    <div class="ci-content  mCustomScrollbar">
      <div class="ci-edu-list">
        ...
        <?php else : ?>
          <span><?php echo get_phrase('without_shared_picture'); ?></span>
        <?php endif; ?>
      </div>
    </div>
  </div>
