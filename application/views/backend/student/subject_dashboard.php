    ...
    <div class="conty">
      ...
      <div class="cursos cta-with-media" style="background: #<?php echo $row['color']; ?>;">
        <div class="cta-content">
          ...
          <small style="font-size:0.90rem; color:#fff;"><?php echo $this->db->get_where('class', array('class_id' => $ex[0]))->row()->name; ?> "<?php $level = $section_id == 0 ? "Tidak ada level aktif" : $this->db->get_where('section', array('section_id' => $ex[1]))->row()->name;
                                                                                                                                                echo $level; ?>"</small>
        </div>
      </div>
      <!-- Menu -->
          ...
          <div class="row">
            <main class="col col-xl-6 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
              <div id="newsfeed-items-grid">
                ...
                $db = $this->db->query("SELECT homework_id, wall_type,publish_date FROM homework WHERE class_id = $ex[0] AND subject_id = $ex[2] $sql UNION SELECT document_id,wall_type,publish_date FROM document WHERE class_id = $ex[0] AND subject_id = $ex[2] $sql UNION SELECT online_exam_id,wall_type,publish_date FROM online_exam WHERE class_id = $ex[0] AND subject_id = $ex[2] $sql UNION SELECT post_id,wall_type,publish_date FROM forum WHERE class_id = $ex[0] AND subject_id = $ex[2] $sql ORDER BY publish_date DESC LIMIT 10");
                if ($db->num_rows() > 0) :
                          ...
                          <div class="edu-posts cta-with-media verde">
                            <div class="cta-content">
                              ...
                              <div class="descripcion">
                                <?php $homework_info = $this->db->get_where('homework', array('homework_id' => $wall['homework_id']))->row()->description;
                                echo $homework_info;
                                ?>
                              </div>
                              ...
                              <a href="<?php echo base_url(); ?>student/homeworkroom/<?php echo $this->db->get_where('homework', array('homework_id' => $wall['homework_id']))->row()->homework_code; ?>/"><button class="btn btn-rounded btn-posts"><i class="picons-thin-icon-thin-0100_to_do_list_reminder_done"></i> <?php echo get_phrase('view_homework'); ?></button></a>
                            </div>
                          </div>
                        ...
                        <article class="hentry post thumb-full-width">
                          ...
                          <div class="edu-posts cta-with-media verde">
                            <div class="cta-content">
                              ...
                              <a href="<?php echo base_url(); ?>student/online_exams/<?php echo $data; ?>/"><button class="btn btn-rounded btn-posts verde"><i class="picons-thin-icon-thin-0014_notebook_paper_todo"></i> <?php echo get_phrase('go_to_exams'); ?></button></a>
                            </div>
                          </div>
                          <div class="control-block-button post-control-button">
            ...
            <div class="col col-xl-3 order-xl-1 col-lg-6 order-lg-2 col-md-6 col-sm-12 col-12">
              <div class="crumina-sticky-sidebar">
                <div class="sidebar__inner">
                  ...
                  <div class="ui-block">
                    <div class="ui-block-title">
                      <h6 class="title"><?php echo get_phrase('course_activity'); ?></h6>
                    </div>
                    <?php
