              ...
              <div class="sidebar__inner">
                ...
                <div class="ui-block paddingtel">
                  <div class="widget w-create-fav-page">
                    ...
                    <div class="content">
                      <h3 class="title"><?php echo get_phrase('student_welcome_dashboard_message'); ?></h3>
                      <a href="<?php echo base_url(); ?>student/subject/" class="btn btn-warning btn-sm"><?php echo get_phrase('go_to_my_subjects'); ?></a>
                    </div>
                  </div>
                </div>
                <div class="ui-block paddingtel">
                  ...
                  <ul class="widget w-friend-pages-added notification-list friend-requests">
                    ...
                    ?>
                        <li class="inline-items">
                          <a href="<?php echo base_url(); ?>student/group/group_message_read/<?php echo $row['group_message_thread_code']; ?>/">
                          ...
                          <center>
                            <div class="widget w-birthday-alert">
                              ...
                              <div class="content">
                                ...
                                <a href="<?php echo base_url(); ?>student/birthdays/" class="text-white">
...
<script>
  ...
  function vote(poll_code) {
    ...
    if (answer != "" && poll_code != "") {
      $.ajax({
        url: "<?php echo base_url(); ?>student/polls/response/",
        type: 'POST',
        data: {
          answer: answer,
          poll_code: poll_code
