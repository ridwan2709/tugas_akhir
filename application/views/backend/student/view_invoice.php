			...
			<div class="content-i">
				<div class="content-box">
					<div class="element-wrapper">
						<a href="<?php echo base_url();?>student/invoice/" class="btn btn-rounded btn-info"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i> <?php echo get_phrase('return');?></a>
