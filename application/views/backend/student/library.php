    ...
    <div class="content-box">
      ...
      <div class="row">
        <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
          <?php echo form_open(base_url() . 'student/library/', array('class' => 'form m-b')); ?>
                  ...
                  <tbody>
                    ...
                    foreach ($book_requests as $row) { ?>
                      <tr>
                        ...
                        <td><img alt="" src="<?php echo $this->crud_model->get_image_url('student', $row['student_id']); ?>" style="height: 25px; border-radius:50%;" class="purple"><span><?php echo $this->crud_model->get_name('student', $row['student_id']); ?></span></td>
