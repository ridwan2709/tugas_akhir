                        ...
                        ?>
                          <tr>
                            ...
                            <td class="bolder">
                              ...
                              $author = $this->crud_model->get_name('student', $this->session->userdata('login_user_id'));
                              if ($b['tulisan_pengguna_id'] == $id && $b['tulisan_author'] == $author) { ?>
                                <a style="color:grey;" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit'); ?>" href="<?php echo base_url(); ?>student/edit_blog/<?php echo $b['tulisan_id']; ?>"><i class="picons-thin-icon-thin-0001_compose_write_pencil_new"></i></a>
                                <a style="color:grey;" data-toggle="tooltip" data-placement="top" data-original-title="Baca Blog" href="<?php echo base_url(); ?>student/baca_blog/<?php echo $b['tulisan_id']; ?>"><i class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i></a>
                                <a style="color:grey;" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete'); ?>" class="danger" href="<?php echo base_url(); ?>student/blog/delete/<?php echo $b['tulisan_id']; ?>/<?php echo $data; ?>/" class="delete"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
                              <?php } else { ?>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="color:grey;" data-toggle="tooltip" data-placement="top" data-original-title="Baca Blog" href="<?php echo base_url(); ?>student/baca_blog/<?php echo $b['tulisan_id']; ?>"><i class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i></a>
                              <?php } ?>
                            </td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="ui-block-content">
          <?php echo form_open(base_url() . 'student/blog/create/', array('enctype' => 'multipart/form-data')); ?>
          <div class="row">
