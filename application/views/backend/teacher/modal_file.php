...
?>   
    ...
    <div class="modal-body">
        <div class="modal-header" style="background-color:#00579c">
            <h6 class="title" style="color:white"><?php echo get_phrase('files');?></h6>
        </div>
                    ...
                    <table id="dataTable1" width="100%" class="table table-striped table-lightfont">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="<?php echo base_url();?>uploads/homework_delivery/<?php echo $row['file'];?>" target="_blank"><?php echo get_phrase('download');?></a></td>
                            </tr>
                        <?php };?>
                        </tbody>
                    </table>    
