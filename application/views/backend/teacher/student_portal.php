			...
			<div class="content-box">
				<div class="conty">
					<div class="back" style="margin-top:-20px;margin-bottom:10px">
						<a title="<?php echo get_phrase('return'); ?>" href="<?php echo base_url(); ?>teacher/students_area/"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a>
					</div>
					<div class="row">
												...
												<div class="row">
													<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
														<ul class="widget w-personal-info item-block">
															...
															<li>
																<span class="title"><?php echo 'Asal Sekolah'; ?>:</span>
																<span class="text"><?php echo $row['sekolah']; ?></span>
															</li>
															<li>
													...
													<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
														<ul class="widget w-personal-info item-block">
															<li>
																<span class="title"><?php echo 'Ibu'; ?>:</span>
															...
															<li>
																<span class="title"><?php echo 'Ayah'; ?>:</span>
															...
															<li>
																<span class="title"><?php echo 'Tempat Lahir'; ?>:</span>
																<span class="text"><?php echo $row['tempat_lahir']; ?></span>
															</li>
															<li>
																<span class="title"><?php echo get_phrase('gender'); ?>:</span>
																<span class="text"><?php if ($row['sex'] == 'M') echo get_phrase('male');
																					else echo get_phrase('female'); ?></span>
															</li>
															<li>
											...
											<div class="help-support-block">
												...
												<ul class="help-support-list">
													<li>
														...
														<a href="<?php echo base_url(); ?>teacher/student_portal/<?php echo $student_id; ?>/"><?php echo get_phrase('personal_information'); ?></a>
													</li>
													<li>
														<i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
														<a href="<?php echo base_url(); ?>teacher/view_marks/<?php echo $student_id; ?>/"><?php echo get_phrase('marks'); ?></a>
													</li>
													<li>
														<i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
														<a href="<?php echo base_url(); ?>teacher/student_profile_report/<?php echo $student_id; ?>/"><?php echo get_phrase('behavior'); ?></a>
													</li>
												</ul>
											</div>
										</div>
