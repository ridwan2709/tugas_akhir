  ...
  <div class="conty">
    ...
    <div class="content-i">
      <div class="content-box">
       ...
       <form action="<?= base_url(); ?>teacher/input_nilai/<?=$param2?>/<?=$student_id?>" method="POST">
        <?php
        $count = 1; 
          ...
          <element class="col-sm-6 col-aligncenter">
            <div class="pipeline white lined-danger">            
              <div class="pipeline-header">
                ...
                <span>Bobot Nilai : <?php echo $mark;?></span>
                &nbsp; &nbsp; &nbsp; &nbsp;
                <input type="number"  name="<?=$count++?>" style="padding:0px; width:52px; text-align: center; float:right"><span style="float: right; margin-right:5px"><?php echo get_phrase('result');?> : </span>
              </div>
              <?php if ($question_type == 'multiple_choice'):
                ...
                ?>
                <i>Jawaban Siswa : <br/><strong><?php echo rtrim(trim($r), ',');?></strong></i>
                <br><br><br>
                <?php
              ...
              <?php elseif($question_type == 'fill_in_the_blanks'):
                ...
                <i>Jawaban Siswa : <br/><strong><?php echo $submitted_answer;?></strong></i><br/><br/><br/>
