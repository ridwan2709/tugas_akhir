...
<?php $fc_info_data = base64_decode($data); $fc_ex = explode("-", $fc_info_data);?>
    ...
    <div class="page-title">
          ...
          <div class="fancy-selector-options">
            ...
            ?>
            <a href="<?php echo base_url();?>teacher/subject_dashboard/<?php echo base64_encode($fc_ex[0].'-'.$fc_ex[1].'-'.$fancy_row2['subject_id']);?>/"><div class="fancy-selector-option <?php if($fancy_row2['subject_id'] == $fc_ex[2]) echo "active";?>">
              <div class="fs-img">
                ...
                ?>
                  <li>
                    ...
                    <div class="float-right">
							        <a class="delete" style="margin-right: 15px;" href="<?php echo base_url();?>teacher/notification/delete/<?php echo $fancy_notify['id'];?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" style="color:red !important; font-size:18px"></i></a>
                    </div>
                    </li>
                  <?php endforeach;?>
                </ul>
            ...
            <div class="author-page author vcard inline-items more">
                ...
                <a href="#" class="author-name fn">
                    <div class="author-title">
                        <?php echo $this->crud_model->get_name('teacher', $this->session->userdata('login_user_id'));?> <svg class="olymp-dropdown-arrow-icon"></svg>
                    </div>
                ...
                ?>
                  <li>
                    ...
                    <div class="notification-event">
                      ...
                      <span class="notification-date"><time class="entry-date updated"><?php echo $fancy_notify['date'];?> <?php echo get_phrase('at');?> <?php echo $fancy_notify['time'];?></time></span>
                      <a class="delete" style="margin-right: 15px;" href="<?php echo base_url();?>teacher/notification/delete/<?php echo $fancy_notify['id'];?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" style="color:#528dbd !important; font-size:14px"></i></a>
                    </div>
                    </li>
                  <?php endforeach;?>
                </ul>
