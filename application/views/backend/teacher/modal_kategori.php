<?php  $edit_data = $this->db->get_where('kategori' , array('id_kategori' => $param2))->result_array();
...
?>    
          <div class="modal-content">
            ...
            <?php echo form_open(base_url() . 'teacher/galeri/edit/'.$row['id_kategori'], array('enctype' => 'multipart/form-data')); ?>
