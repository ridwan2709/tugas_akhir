...
?>
  ...
  <div class="modal-content">
    ...
    <div class="modal-header">
      <h6 class="title"><?php echo 'Perbarui Subjek'; ?></h6>
    </div>
    <?php echo form_open(base_url() . 'teacher/courses/update/' . $row['subject_id'] . "/" . $row['class_id'], array('enctype' => 'multipart/form-data')); ?>
    <div class="modal-body">
      <div class="ui-block-content">
        <div class="row">
          <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="form-group label-floating">
              <label class="control-label"><?php echo 'Nama Pelajaran'; ?></label>
              <input class="form-control" placeholder="" value="<?php echo $row['name']; ?>" name="name" type="text" required disabled style="background-color: #ffffff;">
            </div>
          </div>
          <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="form-group">
              <label class="control-label"><?php echo get_phrase('about_the_subject'); ?></label>
              <textarea style="width:100%;" class="ckeditor1" id="about" name="about"><?php echo $row['about'] ?></textarea>
            </div>
          </div>
          <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="form-group label-floating">
          ...
          <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="form-group label-floating is-select">
              <label class="control-label"><?php echo 'Koordinator Mapel'; ?></label>
              <div class="select">
                <select name="teacher_id" required="" disabled>
