												...
												<div class="row">
													...
													<div class="col-sm-6">
														<div class="form-group label-floating">
															...
															<input class="form-control" type="text" name="tempatLahir" value="<?php echo $row['tempatLahir']; ?>">
															<span class="material-input"></span>
															<span class="material-input"></span>
														</div>
													</div>
													...
													<div class="col-sm-6">
														<div class="form-group label-floating">
															...
															<input class="form-control" type="text" name="pendidikanTerakhir" value="<?php echo $row['pendidikanTerakhir']; ?>">
															<span class="material-input"></span>
															<span class="material-input"></span>
														</div>
													</div>
