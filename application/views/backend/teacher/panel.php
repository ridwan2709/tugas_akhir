          ...
          <main class="col col-xl-6 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
            ...
            if ($checkNews != $checkNewsNew) { ?>
              <div class="col align-center mb-3">
                <a class="animate__animated animate__bounceIn animate__infinite animate__slow btn btn-primary btn-rounded" href="<?= base_url() . 'teacher/readNews/' . $checkNews ?>">Ada <?= $cekCount ?> berita/informasi belum dibaca</b></a>
              </div>
            <?php } else {
              //tidak ditampilkan
            }
            ...
            <div id="panel">
              <?php
              $db = $this->db->query("SELECT description, publish_date, type,news_id FROM news WHERE news_id <= '$checkNews' UNION SELECT question,publish_date,type,id FROM polls ORDER BY publish_date DESC LIMIT 5")->result_array();
              foreach ($db as $wall) :
              ?>
              ...
              <div class="sidebar__inner">
                ...
                <div class="ui-block paddingtel">
                  <div class="widget w-create-fav-page">
                    ...
                    <div class="content">
                      <h3 class="title"><?php echo get_phrase('welcome_teacher_dashboard'); ?></h3>
                      <a href="<?php echo base_url(); ?>teacher/grados/" class="btn btn-warning btn-sm"><?php echo get_phrase('go_to_my_classes'); ?></a>
                    </div>
                  </div>
                </div>
                <div class="ui-block paddingtel">
                  ...
                  <ul class="widget w-friend-pages-added notification-list friend-requests">
                    <?php
                    $anggota = $this->session->userdata('login_type') . '_' . $this->session->userdata('login_user_id');
                    $this->db->limit(5);
                    $this->db->like('members', $anggota);
                    ...
                    ?>
                        <li class="inline-items">
                          <a href="<?php echo base_url(); ?>teacher/group/group_message_read/<?php echo $row['group_message_thread_code']; ?>/">
                          ...
                          <center>
                            <div class="widget w-birthday-alert">
                              ...
                              <div class="content">
                                ...
                                <a href="<?php echo base_url(); ?>teacher/birthdays/" class="text-white">
                                  <p><?php echo 'Lihat semua hari lahir'; ?></p>
                                </a>
                              </div>
                            </div>
                          </center>
...
<script>
  ...
  function vote(poll_code) {
    ...
    if (answer != "" && poll_code != "") {
      $.ajax({
        url: "<?php echo base_url(); ?>teacher/polls/response/",
        type: 'POST',
        data: {
          answer: answer,
          poll_code: poll_code
