		...
		<div class="os-tabs-w menu-shad">
			<div class="os-tabs-controls">
				<ul class="navs navs-tabs upper">
					<li class="navs-item">
						<a href="<?php echo base_url(); ?>teacher/request/" class="navs-links active"><i class="os-icon picons-thin-icon-thin-0015_fountain_pen"></i><span><?php echo get_phrase('permissions'); ?></span></a>
					</li>
					<li class="navs-item">
						<a href="<?php echo base_url(); ?>teacher/alatdanbahan/" class="navs-links"><i class="os-icon picons-thin-icon-thin-0465_shopping_cart_basket_store"></i><span><?php echo "Alat dan Bahan"; ?></span></a>
					</li>
				</ul>
			</div>
		</div>
						...
						<div class="element-wrapper">
							<div class="element-box lined-primary">
								...
								<div class="form-buttons-w text-right">
									<button class="btn btn-primary btn-rounded" type="submit"> <?php echo get_phrase('send'); ?></button>
								</div>
								<?php echo form_close(); ?>
							</div>
						</div>
