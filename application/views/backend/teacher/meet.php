    ...
    <div class="conty">
      ...
      <div class="cursos cta-with-media" style="background: #<?php echo $row['color']; ?>;">
        <div class="cta-content">
          ...
          <h3 class="cta-header"><?php echo $row['name']; ?> - <small><?php echo get_phrase('live'); ?></small></h3>
                            ...
                            <tr>
                              ...
                              <td class="text-center bolder">
                                <?php if ($row['liveType'] == 2) {?>
                                  <a href="<?= $row['siteUrl'] ?>" target="_blank" style="color:gray;"><span><i style="color:gray;" class="picons-thin-icon-thin-0139_window_new_extern_full_screen_maximize"></i></span></a>
                                <?php }else{ ?>
                                ...
                                <a style="color:grey;" class="delete" href="<?php echo base_url(); ?>teacher/meet/delete/<?php echo $row['live_id'] ?>/<?php echo $data; ?>"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
                              </td>
                            </tr>
                          <?php endforeach; ?>
                        </tbody>
