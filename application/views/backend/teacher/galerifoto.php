        ...
        <div class="content-i">
            <div class="content-box">
                <div class="back" style="margin-top:-20px;margin-bottom:10px">
                    <a href="<?php echo base_url(); ?>teacher/galeri/"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a>
                </div>
                            ...
                            <div class="col col-xl-3 col-lg-3 col-md-6 col-sm-6 portfolio-item filter-iht">
                                <div class="portfolio-wrap">
                                    ...
                                    <div class="portfolio-links-top" style="text-align: right;">
                                        ...
                                        <a href="<?php echo base_url(); ?>teacher/galerifotos/delete/<?= $data['id_galeri']; ?>/<?= $data['id_kategori']; ?>" class="delete"><i style="font-size:20px;" class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete'); ?>"></i></a>
                                    </div>
                                </div>
                            </div>
                        <?php
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="ui-block-title" style="background-color:#00579c">
                    <h6 class="title" style="color:white">Foto Baru</h6>
                </div>
                <div class="ui-block-content">
                    <?php echo form_open(base_url() . 'teacher/galerifotos/create/' . $id_kategori, array('enctype' => 'multipart/form-data')); ?>
                    <div class="row">
