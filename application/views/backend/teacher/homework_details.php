    ...
    <div class="os-tabs-w menu-shad">
      <div class="os-tabs-controls">
        <ul class="navs navs-tabs upper">
          <li class="navs-item">
            <a class="navs-links" href="<?php echo base_url(); ?>teacher/homeworkroom/<?php echo $homework_code; ?>/"><i class="os-icon picons-thin-icon-thin-0014_notebook_paper_todo"></i><span><?php echo get_phrase('homework_details'); ?></span></a>
          </li>
          <li class="navs-item">
            <a class="navs-links active" href="<?php echo base_url(); ?>teacher/homework_details/<?php echo $homework_code; ?>/"><i class="os-icon picons-thin-icon-thin-0100_to_do_list_reminder_done"></i><span><?php echo get_phrase('deliveries'); ?></span></a>
          </li>
          <li class="navs-item">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><a class="btn btn-rounded btn-sm btn-secondary" href="<?php echo base_url(); ?>teacher/single_homework/<?php echo $row['id']; ?>" style="color:white"><i class="os-icon picons-thin-icon-thin-0043_eye_visibility_show_visible"></i> <?php echo get_phrase('view_response'); ?></a>
                        </td>
                        <td><?php echo $row['teacher_comment']; ?></td>
                        <td><?php echo $row['mark']; ?></td>
                        <td width="7%">
                          <a class="btn btn-danger btn-md delete" href="<?php echo base_url(); ?>teacher/delete_delivery/<?php echo $row['id']; ?>/<?php echo $homework_code; ?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" style="color:#fff"></i></a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
