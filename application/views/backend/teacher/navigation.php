  ...
  <div class="fixed-sidebar-left sidebar--small" id="sidebar-left">
    ...
    <div class="mCustomScrollbar" data-mcs-theme="dark">
      <ul class="left-menu">
        ...
        <li <?php if ($page_name == 'karakter_building' || $page_name == 'forum_konseling' || $page_name == 'student_report' || $page_name == 'meet_konseling' || $page_name == 'live_konseling' || $page_name == 'forum_room_konseling' || $page_name == 'view_report' || $page_name == 'edit_forum_diskusi' ) : ?>class="currentItem" <?php endif; ?>>
          <a href="<?php echo base_url(); ?>teacher/karakter_building/" data-toggle="tooltip" data-placement="right" data-original-title="Pembinaan">
            <div class="left-menu-icon">
              <i class="picons-thin-icon-thin-0389_gavel_hammer_law_judge_court"></i>
            </div>
          </a>
        </li>
        <li <?php if ($page_name == 'news' || $page_name == 'galeri' || $page_name == 'blog' || $page_name == 'galerifoto') : ?>class="currentItem" <?php endif; ?>>
  ...
  <div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1">
    ...
    <div class="mCustomScrollbar" data-mcs-theme="dark">
      <ul class="left-menu">
        ...
        <li <?php if ($page_name == 'karakter_building' || $page_name == 'forum_konseling' || $page_name == 'student_report' || $page_name == 'meet_konseling' || $page_name == 'live_konseling' || $page_name == 'forum_room_konseling' || $page_name == 'view_report' || $page_name == 'edit_forum_diskusi' ) : ?> class="currentItem" <?php endif; ?>>
          <a href="<?php echo base_url(); ?>teacher/karakter_building/">
            <div class="left-menu-icon">
              <i class="picons-thin-icon-thin-0389_gavel_hammer_law_judge_court"></i>
            </div>
