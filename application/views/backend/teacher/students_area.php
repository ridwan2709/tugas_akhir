                                        ...
                                        <div class="card-box widget-user ui-block list">
                                          <div class="more" style="float:right;">
                                            ...
                                            <ul class="more-dropdown">
                                              <li><a href="<?php echo base_url(); ?>teacher/view_marks/<?php echo $row['student_id']; ?>"><?php echo get_phrase('marks'); ?></a></li>
                                            </ul>
                                          </div>
                                          <div>
                                            <img src="<?php echo $this->crud_model->get_image_url('student', $row['student_id']); ?>" class="img-responsive rounded-circle purple" style="border-radius: 50%;" alt="user">
                                            <div class="wid-u-info">
                                              <a href="<?php echo base_url(); ?>teacher/student_portal/<?php echo $row['student_id']; ?>/" class="h6 author-name">
                                                <h5 class="mt-0 m-b-5"> <?php echo $this->crud_model->get_name('student', $row['student_id']); ?></h5>
                                              </a>
                                        ...
                                        foreach ($students as $row2) : ?>
                                          <div class="col-xl-4 col-md-6">
                                            <div class="card-box widget-user ui-block list">
                                              ...
                                              <div>
                                                <img src="<?php echo $this->crud_model->get_image_url('student', $row2['student_id']); ?>" class="img-responsive rounded-circle purple" style="border-radius: 50%;" alt="user">
                                                <div class="wid-u-info">
                                                  <a href="<?php echo base_url(); ?>teacher/student_portal/<?php echo $row['student_id']; ?>/" class="h6 author-name">
