      ...
      <div class="content-box">
        <div>
          <div class="pipeline white lined-primary">
            ...
            echo form_open(base_url() . 'teacher/online_exams/edit/', array('enctype' => 'multipart/form-data')); ?>
            <div class="row">
             <div class="col-sm-4">
              <div class="form-group">
                <label class="col-form-label" for=""><?php echo get_phrase('title');?></label>
                <div class="input-group">
                  <input type="text" class="form-control" name="exam_title" placeholder="Jenis ujian" value="<?php echo $online_exam['title']; ?>">
                </div>
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type='text' class="datepicker-here" data-position="bottom left" data-language='en' name="exam_date" placeholder="Tanggal pelaksanaan ujian" data-multiple-dates-separator="/" value="<?php echo date('m/d/Y', $online_exam['exam_date']); ?>"/>
                </div>
              </div>
            </div>
            <div class="col-sm-4">
            ...
            <div class="col-sm-8">
              <div class="form-group">
                ...
                <textarea class="form-control" name="instruction" placeholder="Petunjuk untuk anak ketika mengerjakan soal ujian" id="ckeditor1"><?php echo $online_exam['instruction']; ?></textarea>
              </div>
            </div>
