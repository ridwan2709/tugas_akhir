...
?>
    <div class="full-chat-middle">
        <div class="chat-head">
            ...
            <div class="user-info">
                <img alt="" src="<?php echo $this->crud_model->get_image_url($re[0], $re[1]); ?>"> <?php echo $this->db->get_where($re[0], array($re[0] . '_id' => $re[1]))->row()->first_name." ".$this->db->get_where($re[0], array($re[0] . '_id' => $re[1]))->row()->last_name; ?>
            </div>
...
<script>
  $(document).ready(function() {
    var chat = $('.full-chat-w .chat-content-w');
