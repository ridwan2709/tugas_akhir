		...
		<div class="conty">
			<div class="content-i">
				<div class="content-box">
					<div class="back">
						<a href="<?php echo base_url(); ?>teacher/student_report/"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a>
					</div>
					<div class="row">
								...
								<?php if ($row['status'] == 0) : ?>
									<div class="row">
										...
										<div class="col-sm-12">
											...
											<a id="add" class="btn btn-success pull-right text-white" href="javascript:void(0);"><?php echo get_phrase('reply'); ?></a><br><br>
										</div>
									</div>
								<?php endif; ?>
								<?php if ($row['status'] == 1) : ?>
									<center>
										<div class="alert alert-success" role="alert"><strong><?php echo get_phrase('success'); ?>!</strong> <?php echo get_phrase('solved'); ?></div>
									</center>
								<?php endif; ?>
								<div id="panel">
									<?php
									...
									?>
										<div class="element-box-w b-t">
											<div class="row m-t m-b">
												<div class="col-sm-10">
													<a href="javascript:void(0);"><img alt="" src="<?php echo $this->crud_model->get_image_url($row2['sender_type'], $row2['sender_id']); ?>" class="purple" width="30px" style="border-radius:50%;margin-right:5px;"> <b><span class="infogi"><?php echo $this->crud_model->get_name($row2['sender_type'], $row2['sender_id']); ?></span></b></a>
						...
						<div class="col-sm-4">
							<div class="ui-block paddingtel lined-danger">
								...
								<div class="ui-block-content">
									<div class="widget w-about" style="text-align:center">
										<a href="javascript:void(0);" class="logo"><img src="<?php echo $this->crud_model->get_image_url('student', $row['student_id']); ?>" alt="Educaby" class="purple" style="border-radius: 50%; width:90px;"></a>
							...
							<div class="ui-block paddingtel lined-danger">
								...
								<?php $user1 = $row['user_id'];
								$user = explode("-", $user1); ?>
								<div class="ui-block-content">
									<div class="widget w-about" style="text-align:center">
										<a href="javascript:void(0);" class="logo"><img src="<?php echo $this->crud_model->get_image_url($user[0], $user[1]); ?>" alt="Educaby" class="purple" style="border-radius: 50%; width:90px;"></a>
										<h4><?php echo $this->crud_model->get_name($user[0], $user[1]); ?><br> <small><?php echo get_phrase('phone'); ?>: <?php echo $this->db->get_where($user[0], array($user[0] . '_id' => $user[1]))->row()->phone; ?>.</small></h4>
	...
	$(document).ready(function() {
		$("#add").click(function() {
			...
			if (message != "" && report_code != "") {
				$.ajax({
					url: "<?php echo base_url(); ?>teacher/student_report/response/",
					type: 'POST',
					data: {
						message: message,
