  									...
  									<div class="app-email-i">
    									<div class="ae-side-menu">
      										...
      										<ul class="ae-main-menu">
        										...
        										<li class="active"><a href="<?php echo base_url();?>teacher/all/"><i class="picons-thin-icon-thin-0130_structure_map_files"></i><span><?php echo get_phrase('all');?></span></a></li>
        										...
        										<li><a href="<?php echo base_url();?>teacher/folders/"><i class="picons-thin-icon-thin-0111_folder_files_documents"></i><span><?php echo get_phrase('folders');?></span></a></li>
      										</ul>
    									</div>
          											...
          											<div class="aec-full-message">
            											<div class="message-head">
              												<div class="user-w with-status status-green">
                												<div class="user-name">
                  													<h4 class="user-title"><?php echo get_phrase('my_files');?></h4>
                  													<div class="user-role"><?php $this->db->where('user_type', 'teacher'); $this->db->where('user_id', $this->session->userdata('login_user_id')); echo $this->db->count_all_results('file');?> <?php echo get_phrase('files');?>.</div>
                												</div>
              												</div>
            											</div>
            											<div class="message -content">
				                                            <ul class="widget w-friend-pages-added notification-list friend-requests">
				                                                <?php
                                                                    ...
                                                                    $this->db->where('user_type', 'teacher'); $this->db->where('user_id', $this->session->userdata('login_user_id'));
      ...
      <div class="modal-dialog window-popup create-friend-group create-friend-group-1" role="document">
        ...
        <?php echo form_open(base_url() . 'teacher/files/create_folder' , array('enctype' => 'multipart/form-data'));?>
          ...
          <div class="modal-header">
            <h6 class="title"><?php echo get_phrase('cerate_folder');?></h6>
          </div>
