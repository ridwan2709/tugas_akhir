<style>
                    ...
                    <div class="app-email-i">
                      <div class="ae-side-menu">
                          ...
                          <ul class="ae-main-menu">
                              ...
                              <li><a href="<?php echo base_url();?>teacher/files/"><i class="picons-thin-icon-thin-0177_puzzle_module_connect"></i><span><?php echo get_phrase('home');?></span></a></li>
                            <li><a href="<?php echo base_url();?>teacher/all/"><i class="picons-thin-icon-thin-0130_structure_map_files"></i><span><?php echo get_phrase('all');?></span></a></li>
                            <li><a href="<?php echo base_url();?>teacher/recent/"><i class="picons-thin-icon-thin-0117_folder_documents_revert_history"></i><span><?php echo get_phrase('recents');?></span></a></li>
                            <li class="active"><a href="<?php echo base_url();?>teacher/folders/"><i class="picons-thin-icon-thin-0111_folder_files_documents"></i><span><?php echo get_phrase('folders');?></span></a></li>
                          </ul>
                      </div>
                                  ...
                                  <div class="message-head">
                                      <div class="user-w with-status status-green">
                                            ...
                                            <div class="user-name">
                                                ...
                                                <div class="user-role"><?php echo get_phrase('total');?>: <?php $this->db->where('user_type','teacher'); $this->db->where('user_id', $this->session->userdata('login_user_id')); echo $this->db->count_all_results('folder');?></div>
                                            </div>
                                            <?php else:?>
                                                <div class="back" style="">   
                                                 <a href="<?php echo base_url();?>teacher/folders/"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a>  
                                             </div>
                                             <div class="user-name">
                                       ...
                                       <?php if($token != ""):?>    
                                        <a href="<?php echo base_url();?>teacher/upload_file/<?php echo $token;?>" class="btn btn-control bg-success" style="color: #fff; float:right;">
                                  ...
                                  <?php if($token == ""):?>     
                                    <ul class="widget w-friend-pages-added notification-list friend-requests">
                                      <?php 
                                        ...
                                        $folders = $this->db->get_where('folder', array('user_type' => 'teacher', 'user_id' => $this->session->userdata('login_user_id')))->result_array();
                                      ...
                                      <li class="inline-items">
                                        ...
                                        <div class="notification-event">
                                          <a href="<?php echo base_url();?>teacher/folders/<?php echo $row['token'];?>" class="h6 notification-friend"><?php echo $row['name'];?></a>
                                          ...
                                          <a class="delete" href="<?php echo base_url();?>teacher/folders/delete/<?php echo $row['folder_id'];?>"><i style="font-size:15px;" class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full"></i></a>
                                        </div>
                                    ...
                                    <?php else:?>
                                      <ul class="widget w-friend-pages-added notification-list friend-requests">
                                        ...
                                        <li class="inline-items">
                                         ...
                                         <div class="notification-event">
                                            <a href="<?php echo base_url();?>teacher/files/download/<?php echo $file['file_id'];?>" class="h6 notification-friend"><?php echo $file['name'];?> <small><b>(<?php echo str_replace("*", "", $file['size']);?>)</b></small></a>
                                           <span class="chat-message-item"><?php echo $file['date'];?></span>
                                           <br>
                                           <a href="<?php echo base_url();?>teacher/files/download/<?php echo $file['file_id'];?>"><i style="font-size:15px;" class="picons-thin-icon-thin-0123_download_cloud_file_sync"></i></a>
                                           <a class="delete" href="<?php echo base_url();?>teacher/files/delete/<?php echo $file['file_id'];?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" style="font-size:15px;"></i></a>
                                         </div>
                                       </li>
                                    <?php endforeach;?>
                                    </ul>
 ...
 <div class="modal fade" id="bulkupload" tabindex="-1" role="dialog" aria-labelledby="bulkupload" aria-hidden="true" style="top:50px;">
      <div class="modal-dialog window-popup create-friend-group create-friend-group-1" role="document">
        ...
        <?php echo form_open(base_url() . 'teacher/files/create_folder' , array('enctype' => 'multipart/form-data'));?>
          <a href="#" class="close icon-close" data-dismiss="modal" aria-label="Close"></a>
          <div class="modal-header">
            <h6 class="title"><?php echo get_phrase('create_new_folder');?></h6>
          </div>
