                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td class="bolder">
                                <a style="color:grey;" href="<?php echo base_url(); ?>teacher/homeworkroom/<?php echo $hm['homework_code']; ?>" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('view_homework'); ?>"><i class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i></a>
                                <a style="color:grey;" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete'); ?>" class="danger delete" href="<?php echo base_url(); ?>teacher/homework/delete/<?php echo $hm['homework_code']; ?>/<?php echo $data; ?>/"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
                              </td>
                            </tr>
                          <?php endforeach; ?>
                        </tbody>
