                        ...
                        <article class="hentry post thumb-full-width">
                          <div class="post__author author vcard inline-items">
                            ...
                            <div class="more">
                              ...
                              <ul class="more-dropdown">
                                ...
                                <li><a class="delete" href="<?php echo base_url(); ?>teacher/homework/delete/<?php echo $this->db->get_where('homework', array('homework_id' => $wall['homework_id']))->row()->homework_code; ?>/<?php echo $data; ?>/"><?php echo get_phrase('delete'); ?></a></li>
                              </ul>
                            </div>
                          </div>
                          <div class="edu-posts cta-with-media verde">
                            <div class="cta-content">
                              ...
                              <a href="<?php echo base_url(); ?>teacher/homeworkroom/<?php echo $this->db->get_where('homework', array('homework_id' => $wall['homework_id']))->row()->homework_code; ?>/"><button class="btn btn-rounded btn-posts"><i class="picons-thin-icon-thin-0100_to_do_list_reminder_done"></i> <?php echo get_phrase('view_homework'); ?></button></a>
                            </div>
                          </div>
                          ...
                          <div class="post__author author vcard inline-items">
                            ...
                            <div class="more">
                              ...
                              <ul class="more-dropdown">
                                ...
                                <li><a class="delete" href="<?php echo base_url(); ?>teacher/manage_exams/delete/<?php echo $this->db->get_where('online_exam', array('online_exam_id' => $wall['homework_id']))->row()->online_exam_id; ?>/<?php echo $data; ?>"><?php echo get_phrase('delete'); ?></a></li>
                              </ul>
                            </div>
                          </div>
                          <div class="edu-posts cta-with-media verde">
                          ...
                          <div class="post__author author vcard inline-items">
                            ...
                            <div class="more">
                              ...
                              <ul class="more-dropdown">
                                ...
                                <li><a class="delete" href="<?php echo base_url(); ?>teacher/forum/delete/<?php echo $this->db->get_where('forum', array('post_id' => $wall['homework_id']))->row()->post_code; ?>/<?php echo $data; ?>"><?php echo get_phrase('delete'); ?></a></li>
                              </ul>
                            </div>
                          </div>
                          <div class="edu-posts cta-with-media verde">
