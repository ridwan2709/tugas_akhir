												...
												<div class="row">
													<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
														<ul class="widget w-personal-info item-block">
															...
															<li>
																...
																<span class="text"><?php echo $row['tempatLahir']; ?></span>
															</li>
															<li>
															...
															<li>
																<span class="title"><?php echo 'NIP'; ?>:</span>
													...
													<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
														<ul class="widget w-personal-info item-block">
															...
															<li>
																<span class="title"><?php echo 'Pendidikan Terakhir'; ?>:</span>
																<span class="text"><?php echo $row['pendidikanTerakhir']; ?></span>
															</li>
															<li>
											...
											<div class="help-support-block">
												...
												<ul class="help-support-list">
													<li>
														...
														<a href="<?php echo base_url(); ?>teacher/my_account/"><?php echo get_phrase('personal_information'); ?></a>
													</li>
													<li>
														<i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
														<a href="<?php echo base_url(); ?>teacher/teacher_update/"><?php echo get_phrase('update_information'); ?></a>
													</li>
												</ul>
											</div>
										</div>
											...
											<div class="pricing-plan col-sm-6">
												...
												<div class="plan-body"><br><br>
													<div class="plan-btn-w">
														...
														<?php else : ?>
															<a class="btn btn-danger btn-rounded" href="<?php echo base_url(); ?>teacher/my_account/remove_facebook/"><?php echo get_phrase('unlink'); ?></a>
														<?php endif; ?>
													</div>
												</div>
											</div>
											<div class="pricing-plan col-sm-6">
												...
												<div class="plan-body"><br><br>
													<div class="plan-btn-w">
														...
														<?php else : ?>
															<a class="btn btn-danger btn-rounded" href="<?php echo base_url(); ?>teacher/my_account/remove_google/"><?php echo get_phrase('unlink'); ?></a>
														<?php endif; ?>
													</div>
												</div>
											</div>
