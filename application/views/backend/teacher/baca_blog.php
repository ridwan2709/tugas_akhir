                  ...
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      ...
                      <ul class="more-dropdown">
                        <li><a href="<?php echo base_url();?>teacher/edit_blog/<?php echo $row['tulisan_id'];?>/"><?php echo get_phrase('edit');?></a></li>
                        <li><a href="<?php echo base_url();?>teacher/blog/delete/<?php echo $row['tulisan_id'];?>/"><?php echo get_phrase('delete');?></a></li>
                      </ul>
                    </div>                
                  </div>                
