                            ...
                            <tbody>
                              ...
                              ?>
                                ...
                                <tr>
                                  ...
                                  <td class="bolder">
                                    <a href="<?php echo base_url(); ?>teacher/looking_report/<?php echo $row['code']; ?>/" style="color:grey;"><i style="font-size:20px;" class="picons-thin-icon-thin-0012_notebook_paper_certificate" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('view_details'); ?>"></i></a>
                                  </td>
                                </tr>
                              <?php endforeach; ?>
                            </tbody>
