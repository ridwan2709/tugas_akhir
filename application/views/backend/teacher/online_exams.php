                        ...
                        <tbody>
                         ...
                         foreach($online_exams as $row):
                          ...
                          <tr>
                           ...
                           <td class="bolder">
                            <a href="<?php echo base_url();?>teacher/examroom/<?php echo $row['online_exam_id'];?>" class="btn btn-success btn-sm"> <?php echo get_phrase('details');?></a><br>
                            <?php if ($row['status'] == 'pending'): ?>
                              <a href="<?php echo base_url();?>teacher/manage_online_exam_status/<?php echo $row['online_exam_id'];?>/published/<?php echo $data;?>/"  class="btn btn-info btn-sm save"><?php echo get_phrase('publish');?></a><br>
                              <?php elseif ($row['status'] == 'published'): ?>
                                <a href="<?php echo base_url();?>teacher/manage_online_exam_status/<?php echo $row['online_exam_id'];?>/expired/<?php echo $data;?>/"  class="btn btn-primary btn-sm delete"> <?php echo get_phrase('mark_as_expired');?></a><br>
                                <?php elseif($row['status'] == 'expired'): ?>
                                  <a href="#" class="btn btn-warning btn-sm"> <?php echo get_phrase('expired');?></a><br>
                                <?php endif; ?>
                                <a class="btn btn-danger btn-sm delete" href="<?php echo base_url();?>teacher/manage_exams/delete/<?php echo $row['online_exam_id'];?>/<?php echo $data;?>/"><?php echo get_phrase('delete');?></a>
                              </td>
                            </tr>
                          <?php endforeach;?>
                        </tbody>
