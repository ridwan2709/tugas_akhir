						...
						<div class="col-sm-8">
							<div class="pipeline white lined-primary">
								...
								<div class="row">
									...
									<div class="col col-lg-4 col-md-4 col-sm-4 col-4">
										<div class="custom-control custom-radio">
											<input type="radio" <?php if ($row['type'] == 3) echo 'checked'; ?> name="type" id="3" value="3" class="custom-control-input"> <label for="3" class="custom-control-label"><?php echo get_phrase('study_material'); ?></label>
										</div>
									</div>
								</div>
