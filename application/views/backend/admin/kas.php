            ...
            <div class="tab-pane active" id="expenses">
              <div class="col col-lg-6 col-md-6 col-sm-12 col-12" style="max-width: 100%">
                <div style="margin: auto 0; float: right;">
                  <button class="btn btn-success btn-rounded btn-upper" data-target="#kas_baru" data-toggle="modal" type="button" style="margin: auto 0;float:right;">+ <?php echo 'Kas baru'; ?></button>
                </div>
                <br><br><br>
                <?php
                echo form_open(base_url('admin/kas/cari'));
                ?>
                <div class="display-flex">
                  <div class="form-group label-floating" style="background-color: #fff;flex-grow:1; margin-right:30px">
                    <label class="control-label">Cari judul kas</label>
              ...
              <div class="element-wrapper">
                <h6 class="element-header"><?php echo 'Kas'; ?></h6>
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td class="bolder">
                                <a href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_edit_kas/<?php echo $row['kas_id']; ?>');" style="color:grey;"><i style="font-size:20px;" class="picons-thin-icon-thin-0001_compose_write_pencil_new" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit'); ?>"></i></a>
                                <a class="delete" href="<?php echo base_url(); ?>admin/kas/delete/<?php echo $row['kas_id']; ?>" style="color:grey;"><i style="font-size:20px;" class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete'); ?>"></i></a>
                              </td>
                            </tr>
                          <?php endforeach; ?>
                        </tbody>
...
<div class="modal fade" id="kas_baru" tabindex="-1" role="dialog" aria-labelledby="kas_baru" aria-hidden="true">
  <div class="modal-dialog window-popup create-friend-group create-friend-group-1" role="document">
    <div class="modal-content">
      <?php echo form_open(base_url() . 'admin/kas/create/'); ?>
      <a href="#" class="close icon-close" data-dismiss="modal" aria-label="Close"></a>
      <div class="modal-header">
        <h6 class="title"><?php echo "Tambahkan kas"; ?></h6>
      </div>
      <div class="modal-body">
        <div class="form-group with-button">
          <input class="form-control" type="text" name="judul" placeholder="<?php echo get_phrase('title'); ?>" required="">
        </div>
        <div class="form-group label-floating is-select">
          ...
          <div class="select">
            <select name="kategori" required="">
              ...
              <option value="1">Kredit/Pemasukan</option>
              <option value="2">Debit/Pengeluaran</option>
            </select>
          </div>
        </div>
        <div class="form-group with-button">
