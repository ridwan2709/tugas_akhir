...
<div class="content-w">
  ...
  <div class="header-spacer"></div>
	...
	<a href="<?php echo base_url();?>admin/blog/"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a>	
	</div>	
        <div class="row">
                  ...
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      ...
                      <ul class="more-dropdown">
                        <li><a href="<?php echo base_url();?>admin/edit_blog/<?php echo $row['tulisan_id'];?>/"><?php echo get_phrase('edit');?></a></li>
                        <li><a href="<?php echo base_url();?>admin/blog/delete/<?php echo $row['tulisan_id'];?>/"><?php echo get_phrase('delete');?></a></li>
                      </ul>
                    </div>                
                  </div>                
        ...
        <div class="ui-block-content">
            <div class="table-responsive">
              <table class="table table-lightbor">
                ...
                <?php
                  $komentar = $this->db->get_where('tbl_komentar', array('komentar_tulisan_id' => $id, 'komentar_parent' => 0))->result_array();
                  foreach ($komentar as $data) {
                ?>
                <tr>
                  <td><?= $data['komentar_isi'] ?></td>
                  <td>
                  <?php
                    if ($data['komentar_status']==0) { ?>
                      <a style="color:grey;" href="<?= base_url('admin/komentar/publish/').$data['komentar_id'].'/'.$id ?>" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('publish'); ?>" ><i class="picons-thin-icon-thin-0317_send_post_paper_plane"></i>&nbsp;</a>
                    <?php } else {  ?>
                      <a style="color:grey;" data-toggle="tooltip" data-placement="top" data-original-title="Balas" href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/balas_komentar/<?php echo $data['komentar_id'];?>');"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i>&nbsp;</a>
                      <?php } ?>
                  <a style="color:grey;" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete'); ?>" class="danger delete" href="<?php echo base_url(); ?>admin/komentar/delete/<?php echo $data['komentar_id']; ?>/<?= $data['komentar_tulisan_id'] ?>" <i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
                  </td>
                </tr>
                <?php } ?> 
              </table>
