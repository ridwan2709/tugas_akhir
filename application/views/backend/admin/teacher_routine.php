    ...
    <div class="os-tabs-w menu-shad">
      <div class="os-tabs-controls">
        <ul class="navs navs-tabs upper">
          ...
          <li class="navs-item">
            <a class="navs-links active" href="<?php echo base_url(); ?>admin/teacher_routine/"><i class="os-icon picons-thin-icon-thin-0011_reading_glasses"></i><span><?php echo get_phrase('teacher_routine'); ?></span></a>
          </li>
          <li class="navs-item">
            ...
            <div class="element-box table-responsive lined-primary shadow" id="print_area">
              <div>
                <center>
                  ...
                  <img style="max-height:40px;" src="<?php echo $this->crud_model->get_image_url('teacher', $teacher_id); ?>" alt="" class="user-avatar circle purple" style="line-height: 0px" />
                    ...
                    <table class="table table-schedule table-hover" cellpadding="0" cellspacing="0">
                      ...
                      ?>
                        <td style="text-align:center"><?php
                                                      echo $row2['time_start'] . ':' . $row2['time_start_min'] . " <b>" . $row2['amstart'] . "</b>" . ' - ' . $row2['time_end'] . ':' . $row2['time_end_min'] . " <b>" . $row2['amend'] . "</b>";
