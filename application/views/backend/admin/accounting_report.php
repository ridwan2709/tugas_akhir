	...
	<div class="conty">
		...
		<div class="content-i">
			<div class="content-box">
				<h5 class="form-header"><?php echo get_phrase('accounting_report'); ?></h5>
				<hr>
...
<script>
	new Chart(document.getElementById("myChart"), {
		...
		data: {
			...
			datasets: [{
				data: [<?php echo $this->crud_model->invoice_xy('Jan'); ?>, <?php echo $this->crud_model->invoice_xy('Feb'); ?>, <?php echo $this->crud_model->invoice_xy('Mar'); ?>, <?php echo $this->crud_model->invoice_xy('Apr'); ?>, <?php echo $this->crud_model->invoice_xy('May'); ?>, <?php echo $this->crud_model->invoice_xy('Jun'); ?>, <?php echo $this->crud_model->invoice_xy('Jul'); ?>, <?php echo $this->crud_model->invoice_xy('Aug'); ?>, <?php echo $this->crud_model->invoice_xy('Sep'); ?>, <?php echo $this->crud_model->invoice_xy('Oct'); ?>, <?php echo $this->crud_model->invoice_xy('Nov'); ?>, <?php echo $this->crud_model->invoice_xy('Dec'); ?>],
