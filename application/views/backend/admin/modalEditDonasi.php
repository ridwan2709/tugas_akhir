<?php $edit_data    =    $this->db->get_where('donasi', array('kas_id' => $param2))->result_array();
foreach ($edit_data as $row) : ?>
    <div class="modal-body">
        <div class="modal-header" style="background-color:#00579c">
            <h6 class="title" style="color:white"><?php echo "Perbaharui donasi"; ?></h6>
        </div>
        <div class="ui-block-content">
            <?php echo form_open(base_url() . 'admin/donasi/edit/' . $row['kas_id'], array('enctype' => 'multipart/form-data')); ?>
            ...
            <div class="row">
                ...
                <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="description-toggle-content">
                        <div class="h6">Donasi diterima</div>
                        <p></p>
                    </div>
                    <div class="togglebutton">
                        <label><input name="status" value="1" type="checkbox" <?= $row['status'] == 'Diterima' ? 'checked': '' ?>><span class="toggle"></span></label>
                    </div>
                    </div>
                </div>
                <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
