											...
											<div class="row">
												<div class="col-lg-6">
													<div class="value-pair">
														...
														<div class="value badge badge-pill badge-primary"><?php echo get_phrase('accountant'); ?></div>
													</div>
													<div class="value-pair">
											...
											<div class="help-support-block">
												...
												<ul class="help-support-list">
													<li>
														...
														<a href="<?php echo base_url(); ?>admin/accountant_profile/<?php echo $accountant_id; ?>/"><?php echo get_phrase('personal_information'); ?></a>
													</li>
													<li>
														<i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
														<a href="<?php echo base_url(); ?>admin/accountant_update/<?php echo $accountant_id; ?>/"><?php echo get_phrase('update_information'); ?></a>
													</li>
												</ul>
											</div>
										</div>
