                        ...
                        ?>
                          <tr>
                            ...
                            <td class="bolder">
                              ...
                              <a class="delete" href="<?php echo base_url(); ?>admin/expense/delete/<?php echo $row['payment_id']; ?>" style="color:grey;"><i style="font-size:20px;" class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete'); ?>"></i></a>
                            </td>
                          </tr>
                        <?php endforeach; ?>
                      </tbody>
                  ...
                  <div class="table-responsive">
                    <table class="table table-padded">
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            <td><a class="badge badge-primary" href="javascript:void(0);">
                                <?php
                                echo $row['name'];
                                echo $row['amount'];
                                ?></a></td>
                            <td>
                              ...
                              <a class="danger delete" style="color:grey" href="<?php echo base_url(); ?>admin/expense_category/delete/<?php echo $row['expense_category_id']; ?>"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
                            </td>
                          </tr>
                        <?php endforeach; ?>
                      </tbody>
  ...
  <div class="modal-dialog window-popup create-friend-group create-friend-group-1" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group with-button">
          <input class="form-control uang" type="text" name="amount" placeholder="<?php echo get_phrase('amount'); ?>" required="">
        </div>
        <div class="form-group label-floating is-select">
