														...
														<tbody>
															...
															foreach ($students as $subject) : ?>
																<tr>
																	...
																	<td style="text-align: left;"><img alt="" src="<?php echo $this->crud_model->get_image_url('student', $subject['student_id']); ?>" width="25px" style="border-radius: 50%;margin-right:5px;" class="purple"><?php echo $subject['first_name'] . " " . $subject['last_name']; ?></td>
											...
											<div class="help-support-block">
												...
												<ul class="help-support-list">
													<li>
														...
														<a href="<?php echo base_url(); ?>admin/parent_profile/<?php echo $parent_id; ?>/"><?php echo get_phrase('personal_information'); ?></a>
													</li>
													<li>
														<i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
														<a href="<?php echo base_url(); ?>admin/parent_update/<?php echo $parent_id; ?>/"><?php echo get_phrase('update_information'); ?></a>
													</li>
													<li>
														<i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
														<a href="<?php echo base_url(); ?>admin/parent_childs/<?php echo $parent_id; ?>/"><?php echo get_phrase('students'); ?></a>
													</li>
												</ul>
											</div>
										</div>
