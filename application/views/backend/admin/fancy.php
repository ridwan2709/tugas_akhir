...
$fancy_number = $this->crud_model->count_unread_messages();
$fc_info = isset($class_id) ? base64_decode($class_id) : false;
$fc_info_data = isset($data) ? base64_decode($data) : false;
$fc_ex = explode("-", $fc_info_data);
?>
<header class="header" id="site-header">

  <?php if ($page_name == 'subject_dashboard' || $page_name == 'upload_marks' || $page_name == 'online_exams' || $page_name == 'homework' || $page_name == 'forum' || $page_name == 'study_material' || $page_name == 'subject_marks') : ?>
  ...
  <div class="header-content-wrapper" <?php if ($page_name != 'cursos') : ?> style="padding-left: 85px;" <?php endif; ?>>
    ...
    <div class="form-group with-button">
      <input class="form-control js-user-se arch" placeholder="<?php echo get_phrase('search_students'); ?>..." type="text" value="<?php echo isset($search_key) ? base64_decode($search_key) : ''; ?>" name="search_key" required>
    ...
    <div class="control-block">
      <div class="control-icon more has-items">
        ...
        <div class="more-dropdown more-with-triangle triangle-top-center">
              ...
              ?>
                ...
                <li class="message-unread">
                  ...
                  <div class="notification-event">
                    <a href="<?php echo base_url(); ?>admin/message/message_read/<?php echo $fancy_rows['message_thread_code']; ?>/" class="h6 notification-friend"><?php echo $this->crud_model->get_name($fancy_user_to_show_type, $fancy_user_to_show_id); ?></a>
                    <span class="chat-message-item" style="text-align: justify;"><?php if ($rw->sender == $fancy_current_user) echo get_phrase('you') . ": " . substr($rw->message, 0, 90) . '...';
          ...
          <a href="<?php echo base_url(); ?>admin/message/" class="view-all bg-info"><?php echo get_phrase('view_all_messages'); ?></a>
        </div>
      </div>
      <div class="control-icon more has-items">
              ...
              ?>
                <li>
                  ...
                  <div class="float-right">
                    <a class="delete" style="margin-right: 15px;" href="<?php echo base_url(); ?>admin/notifications/delete/<?php echo $fancy_notify['id']; ?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" style="color:red !important; font-size:18px"></i></a>
                  </div>
                </li>
              <?php endforeach; ?>
            </ul>
          </div>
          <a href="<?php echo base_url(); ?>admin/notifications/" class="view-all bg-info"><?php echo get_phrase('view_all_notifications'); ?></a>
        </div>
      </div>
      <div class="author-page author vcard inline-items more">
        <div class="author-thumb">
          <img alt="author" src="<?php echo $this->crud_model->get_image_url('admin', $this->session->userdata('login_user_id')); ?>" class="avatar bg-white" width="32px">
        ...
        <a href="#" class="author-name fn">
          <div class="author-title">
            <?php echo $this->crud_model->get_name('admin', $this->session->userdata('login_user_id')); ?> <svg class="olymp-dropdown-arrow-icon">
              <use xlink:href="<?php echo base_url(); ?>style/olapp/svg-icons/sprites/icons.svg#olymp-dropdown-arrow-icon"></use>
            </svg>
          </div>
        ...
        <ul class="notification-list chat-message">
          ...
          ?>
            ...
            <li class="message-unread">
              ...
              <div class="notification-event">
                <a href="<?php echo base_url(); ?>admin/message/message_read/<?php echo $row1['message_thread_code']; ?>/" class="h6 notification-friend"><?php echo $this->crud_model->get_name($fancy_user_to_show_type, $fancy_user_to_show_id); ?></a>
                <span class="chat-message-item" style="text-align: justify;"><?php if ($rw->sender == $fancy_current_user) echo get_phrase('you') . ": " . substr($rw->message, 0, 90) . '...';
                                                                              else echo substr($rw->message, 0, 90); ?>...</span>
                <span class="notification-date"><time class="entry-date updated"><?php echo $rw->timestamp; ?></time></span>
              </div>
          ...
          ?>
            <li>
              ...
              <div class="notification-event">
                ...
                <span class="notification-date"><time class="entry-date updated"><?php echo $fancy_notify['date']; ?> <?php echo get_phrase('at'); ?> <?php echo $fancy_notify['time']; ?></time></span>
                <a class="delete" style="margin-right: 15px;" href="<?php echo base_url(); ?>admin/notifications/delete/<?php echo $fancy_notify['id']; ?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" style="color:#528dbd !important; font-size:14px"></i></a>
              </div>
            </li>
          <?php endforeach; ?>
        </ul>
