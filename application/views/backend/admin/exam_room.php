                                ...
                                elseif (sizeof($added_question_info) > 0):
                                  ...
                                  foreach ($added_question_info as $added_question): 
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge badge-success"><?php if($added_question['type'] == "fill_in_the_blanks") {echo get_phrase('blank_spaces');} else if($added_question['type'] == "multiple_choice"){echo get_phrase('multilpe_choice');} else if($added_question['type'] == "true_false"){echo get_phrase('true_false');}?></span></td>
                                        <?php if ($added_question['type'] == 'fill_in_the_blanks'): ?>
                                            ...
                                            <td style="text-align: center;">
                                                ...
                                                <a class="btn-dager btn-sm delete" href="<?php echo base_url();?>admin/delete_question_from_online_exam/<?php echo $added_question['question_bank_id'];?>" data-toggle="tooltip" title="<?php echo get_phrase('delete'); ?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>
