        ...
        <div class="top-header-thumb">
          ...
          <div class="top-header-author">
            ...
            <div class="author-content">
              <a href="javascript:void(0);" class="h3 author-name"><?php echo get_phrase('school_bus'); ?></a>
        ...
        <div class="tab-pane active" id="students">
          <div class="element-wrapper">
            <h6 class="element-header">
              ...
              <div style="margin-top:auto;float:right;"><a href="#" data-target="#crearadmin" data-toggle="modal" data-focus="false" class="btn btn-control btn-grey-lighter btn-purple"><i class="picons-thin-icon-thin-0001_compose_write_pencil_new"></i>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <a style="color:grey;" class="delete" class="danger" href="<?php echo base_url(); ?>admin/school_bus/delete/<?php echo $buss['transport_id']; ?>"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
      ...
      <div class="modal-body">
        ...
        <div class="ui-block-content">
          ...
          <div class="row">
            ...
            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
              <div class="form-group label-floating">
                <label class="control-label"><?php echo get_phrase('route'); ?></label>
                <input class="form-control" type="text" name="route" required="">
              </div>
            </div>
            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
              <div class="form-group label-floating">
                <label class="control-label"><?php echo get_phrase('bus_id'); ?></label>
            ...
            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
              <div class="form-group label-floating">
                <label class="control-label"><?php echo get_phrase('driver_phone'); ?></label>
