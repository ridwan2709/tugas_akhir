																...
																?>
																	<li class="ui-block lists">
																		<div class="post__author author vcard inline-items">
																			<img src="<?php echo $this->crud_model->get_image_url('admin', $poll['admin_id']); ?>" class="user-avatar circle purple" style="line-height: 0px">
																		...
																		<a href="<?php echo base_url(); ?>admin/view_poll/<?php echo $poll['poll_code']; ?>/">
																			<strong class="btnss successs pull-right" style="margin-top:-65px; margin-right:-10px; font-size:15px; border-radius:25px; padding:7px; box-shadow: 0 2px 30px 0 rgba(153, 191, 45, 0.20);"><?php $this->db->where('poll_code', $poll['poll_code']);
																																																																		echo $this->db->count_all_results('poll_response'); ?> <?php echo get_phrase('votes'); ?></strong>
																			<h3><span class="bold"><?php echo $poll['question']; ?></span></h3>
																		</a>
																		<a class="delete" href="<?php echo base_url(); ?>admin/polls/delete2/<?php echo $poll['poll_code']; ?>"><i style="font-size:18px;" class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full"></i></a>
																	</li>
																<?php endforeach; ?>
															</ul>
														</div>
