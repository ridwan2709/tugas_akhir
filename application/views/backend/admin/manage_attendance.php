    ...
    <div class="conty">
      ...
      <div class="content-i">
        <div class="content-box">
          ...
          <?php 
            echo form_open(base_url() . 'admin/manage_attendance/'.$data, array('class' => 'form m-b'));
          ?>
        <div class="row">
          <div class="col-sm-4">
            <div class="form-group label-floating" style="background:#fff;">
                <label class="control-label"><?php echo get_phrase('date');?></label>
                <input type='text' class="datepicker-here" data-position="bottom left" data-language='en' name="date" value="<?= $date;?>" data-multiple-dates-separator="/"/>
                <span class="material-input"></span>
            </div>
          </div>
          <div class="col-sm-2">
              <div class="form-group">
                <button class="btn btn-success" style="margin-top:10px" type="submit"><span><?php echo get_phrase('view');?></span></button>
              </div>
          </div>
        </div>
        <?= form_close() ?>
        ...
        <div class="ui-block">
          <article class="hentry post thumb-full-width">
            <?php echo form_open(base_url() . 'admin/attendance_insert/' . $timestamp. '/' . $data); ?>
            <div class="post__author author vcard inline-items">
              ...
              <div class="author-date">
                <a class="h6 post__author-name fn" href="javascript:void(0);"><?php echo get_phrase('attendance'); ?> <small>(<?php echo date("d/m/Y", $timestamp); ?>)</small>.</a>
              </div>
            </div>
                ...
                <table class="table table-lightborder table-bordered">
                  ...
                  <tbody>
                    ...
                    foreach ($students as $row) :
                      $attn = $this->db->get_where('attendance', array('student_id' => $row['student_id'], 'subject_id' => $ex['2'], 'timestamp' => $timestamp))->row(); 
                    ?>
