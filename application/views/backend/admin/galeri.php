                  ...
                  <div class="friend-item-content">
                      <div class="more">
                        ...
                        <ul class="more-dropdown">
                          ...
                          <li><a href="<?php echo base_url();?>admin/galeri/delete/<?php echo $class['id_kategori'];?>" class="delete"><?php echo get_phrase('delete');?></a></li>
                        </ul>
                      </div>
                      <div class="friend-avatar">
                        ...
                        <div class="author-content">
                          ...
                          <a href="<?php echo base_url();?>admin/galerifoto/<?php echo base64_encode($class['id_kategori']);?>/" class="h5 author-name"><?php echo $class['nama'];?></a>
                        </div>
                      </div>        
                    </div>
                  </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="ui-block-content">
           <?php echo form_open(base_url() . 'admin/galeri/create/'.$data, array('enctype' => 'multipart/form-data')); ?>
           <div class="row">
