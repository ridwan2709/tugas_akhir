																		...
																		<tbody>
																			...
																			?>
																				<tr>
																					...
																					<td>
																						<?php if ($row['type'] == 'student') : ?>
																							<a href="<?php echo base_url(); ?>admin/student/accept/<?php echo $row['user_id']; ?>" class="btn btn-primary btn-rounded btn-sm save"><?php echo get_phrase('accepted'); ?></button></a>
																						<?php endif; ?>
																						<?php if ($row['type'] == 'parent') : ?>
																							<a href="<?php echo base_url(); ?>admin/parents/accept/<?php echo $row['user_id']; ?>" class="btn btn-primary btn-rounded btn-sm save"><?php echo get_phrase('accepted'); ?></button></a>
																						<?php endif; ?>
																						<?php if ($row['type'] == 'teacher') : ?>
																							<a href="<?php echo base_url(); ?>admin/teachers/accept/<?php echo $row['user_id']; ?>" class="btn btn-primary btn-rounded btn-sm save"><?php echo get_phrase('accepted'); ?></button></a>
																						<?php endif; ?>
																						<a href="<?php echo base_url(); ?>admin/admissions/reject/<?php echo $row['user_id']; ?>" class="btn btn-danger btn-rounded btn-sm delete"><?php echo get_phrase('rejected'); ?></a>
																					</td>
																				</tr>
																			<?php endforeach; ?>
																		</tbody>
