                  ...
                  <tbody>
                    ...
                    foreach ($book_requests as $row) { ?>
                      <tr>
                        ...
                        <td><img alt="" src="<?php echo $this->crud_model->get_image_url('student', $row['student_id']); ?>" style="height: 25px; border-radius:50%" class="purple"><span><?php echo $this->crud_model->get_name('student', $row['student_id']) ?></td>
                        ...
                        <td>
                          <?php if ($row['status'] == 0) { ?>
                            <a data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('approve'); ?>" class="save" href="<?php echo base_url(); ?>admin/book_request/accept/<?php echo $row['book_request_id']; ?>"><i style="color:gray" class="picons-thin-icon-thin-0154_ok_successful_check"></i></a>
                            <a data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('reject'); ?>" class="delete" href="<?php echo base_url(); ?>admin/book_request/reject/<?php echo $row['book_request_id']; ?>"><i style="color:gray" class="picons-thin-icon-thin-0153_delete_exit_remove_close"></i></a>
                          <?php } else echo get_phrase('no_actions'); ?>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
