  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="ui-block-title" style="background-color:#00579c">
        <h6 class="title" style="color:white"><?php echo get_phrase('update_live');?></h6>
      </div>
      <div class="ui-block-content">
       <?php echo form_open(base_url() . 'admin/meet_konseling/update/'.$param2.'/'.$data, array('enctype' => 'multipart/form-data')); ?>
       <div class="row">
