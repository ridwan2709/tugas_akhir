                                  ...
                                  <div class="card-box widget-user ui-block list">
                                    <div class="more" style="float:right;">
                                      ...
                                      <ul class="more-dropdown">
                                        ...
                                        <li><a class="delete" href="<?php echo base_url(); ?>admin/accountant/delete/<?php echo $row['accountant_id']; ?>"><?php echo get_phrase('delete'); ?></a></li>
                                      </ul>
                                    </div>
                                    <div>
                                      <img src="<?php echo $this->crud_model->get_image_url('accountant', $row['accountant_id']); ?>" class="img-responsive rounded-circle purple" alt="user">
