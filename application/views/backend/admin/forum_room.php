              ...
              <div class="element-box shadow lined-success">
                <div class="row" style="margin:2px;margin-bottom:15px">
                  <div class="col-sm-12">
                    ...
                    <div class="form-group is-empty"><textarea name="message" class="message form-control" id="ckeditor1" placeholder="<?php echo get_phrase('write_message'); ?>..." required="" rows="5" style="width:100%"></textarea><span class="material-input"></span></div>
                    ...
                    foreach ($students as $row2) : ?>
                      <li class="inline-items">
                        <div class="author-thumb">
                          <img src="<?php echo $this->crud_model->get_image_url('student', $row2['student_id']); ?>" alt="" width="35px" class="user-avatar circle purple" style="line-height: 0px">
                        </div>
          ...
          $(document).ready(function() {
            $("#add").click(function() {
              ...
              if (message != "" && post_code != "") {
                $.ajax({
                  url: "<?php echo base_url(); ?>admin/forum_message/add",
                  type: 'POST',
                  data: {
                    message: message,
                    post_code: post_code
