																	...
																	<div class="ui-block list">
																		<div class="more" style="float:right; margin-right:15px; ">
																			...
																			<ul class="more-dropdown" style="z-index:999">
																				...
																				<li><a class="delete" href="<?php echo base_url(); ?>admin/classrooms/delete/<?php echo $room['dormitory_id']; ?>"><?php echo get_phrase('delete'); ?></a></li>
																			</ul>
																		</div>
																		<a href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_classrooms/<?php echo $room['dormitory_id']; ?>');">
																			<div class="birthday-item inline-items">
																				<div class="circle purple"><img src="<?= base_url('uploads/avatars/') . $room['name'][0] . '.svg' ?>"> </div>&nbsp;
																				<div class="birthday-author-name">
																					<div class="h6 author-name"><?php echo $room['name']; ?></div>
																					<div><b><?php echo get_phrase('students'); ?>:</b> <?php $this->db->where('dormitory_id', $room['dormitory_id']);
																																		echo $this->db->count_all_results('student'); ?>.</div>
																				</div>
																			</div>
																		</a>
																	</div>
