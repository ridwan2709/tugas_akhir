        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="element-box shadow shadow lined-primary" style="border-radius:10px;">
              <button class="btn btn-rounded btn-success" data-toggle="modal" data-target="#addlang"><?php echo get_phrase('add_language'); ?></button>
              <hr>
                  ...
                  ?>
                    <div class="col-sm-3">
                      <div class="element-box infodash centered padded" style="background: #a01a7a; border-radius:15px;">
                        ...
                        <div>
                          <h4 style="color: #FFF;"><?php echo $row['phrase']; ?></h4>
                        </div>
