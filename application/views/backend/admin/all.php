  									...
  									<div class="app-email-i">
    									<div class="ae-side-menu">
      										...
      										<ul class="ae-main-menu">
        										...
        										<li class="active"><a href="<?php echo base_url();?>admin/all/"><i class="picons-thin-icon-thin-0130_structure_map_files"></i><span><?php echo get_phrase('all');?></span></a></li>
        										...
        										<li><a href="<?php echo base_url();?>admin/folders/"><i class="picons-thin-icon-thin-0111_folder_files_documents"></i><span><?php echo get_phrase('folders');?></span></a></li>
      										</ul>
    									</div>
            											...
            											<div class="message-head">
              												<div class="user-w with-status status-green">
                												<div class="user-name">
                  													...
                  													<div class="user-role"><?php $this->db->where('user_type', 'admin'); $this->db->where('user_id', $this->session->userdata('login_user_id')); echo $this->db->count_all_results('file');?> <?php echo get_phrase('files');?>.</div>
                												</div>
              												</div>
            											</div>
            											<div class="message -content">
				                                            <ul class="widget w-friend-pages-added notification-list friend-requests">
				                                                <?php
                                                                    ...
                                                                    $this->db->where('user_type', 'admin'); $this->db->where('user_id', $this->session->userdata('login_user_id'));
