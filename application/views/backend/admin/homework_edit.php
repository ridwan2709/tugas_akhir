		...
		<div class="os-tabs-w menu-shad">
			<div class="os-tabs-controls">
				<ul class="navs navs-tabs upper">
					...
					<li class="navs-item">
						<a class="navs-links active" href="<?php echo base_url(); ?>admin/homework_edit/<?php echo $homework_code; ?>/"><i class="os-icon picons-thin-icon-thin-0001_compose_write_pencil_new"></i><span><?php echo get_phrase('edit'); ?></span></a>
					</li>
				</ul>
			</div>
		</div>
					...
					<div class="row">
						<div class="col-sm-8">
							<div class="pipeline white lined-primary">
								...
								<div class="form-group">
									<label> <?php echo get_phrase('description'); ?></label><textarea cols="80" id="ckeditor1" name="description" rows="2"><?php echo $row['description']; ?></textarea>
								</div>
								<div class="form-group">
								...
								<div class="row">
									...
									<div class="col col-lg-4 col-md-4 col-sm-4 col-4">
										<div class="custom-control custom-radio">
											<input type="radio" <?php if ($row['type'] == 3) echo 'checked'; ?> name="type" id="3" value="3" class="custom-control-input"> <label for="2" class="custom-control-label"><?php echo get_phrase('study_material'); ?></label>
										</div>
									</div>
								</div>
								...
								<div class="users-list-w">
									...
									foreach ($students as $row2) : ?>
										<div class="user-w">
											...
											<div class="user-name">
												<h6 class="user-title">
													<?php echo $this->crud_model->get_name('student', $row2['student_id']); ?>
												</h6>
												<div class="user-role">
