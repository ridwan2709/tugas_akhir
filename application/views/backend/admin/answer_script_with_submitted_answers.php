...
<form action="<?= base_url(); ?>admin/input_nilai/<?=$param2?>/<?=$student_id?>" method="POST">
  <?php
  $count = 1; 
    ...
    <element class="col-sm-6 col-aligncenter">
      <div class="pipeline white lined-danger">            
        <div class="pipeline-header">
          ...
          &nbsp; &nbsp; &nbsp; &nbsp;
          <input type="number"  name="<?=$count++?>" style="padding:0px; width:52px; float:right; text-align:center"><span style="float: right; margin-right:5px"><?php echo get_phrase('result');?> : </span>
        </div>
