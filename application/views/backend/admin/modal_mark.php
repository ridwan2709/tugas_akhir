...
foreach($edit_data as $row):
    ...
    <div class="modal-body">
        <div class="modal-header" style="background-color:#00579c">
            <h6 class="title" style="color:white"><?php echo get_phrase('update_activities');?></h6>
        </div>
        <div class="ui-block-content">
          <?php 
          echo form_open(base_url() . 'admin/courses/update_labs/'.$param2, array('enctype' => 'multipart/form-data')); 
          ?>
          <div class="row">
            <input type="hidden" name="section_id" value="<?php echo $param3;?>">
            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group label-floating">
                    <label class="control-label"><?php echo get_phrase('activity');?> 1</label>
            ...
            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group label-floating">
                    <label class="control-label"><?php echo get_phrase('activity');?> 2</label>
            ...
            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group label-floating">
                    <label class="control-label"><?php echo get_phrase('activity');?> 3</label>
            ...
            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group label-floating">
                    <label class="control-label"><?php echo get_phrase('activity');?> 4</label>
            ...
            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group label-floating">
                    <label class="control-label"><?php echo get_phrase('activity');?> 5</label>
            ...
            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group label-floating">
                    <label class="control-label"><?php echo get_phrase('activity');?> 6</label>
            ...
            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group label-floating">
                    <label class="control-label"><?php echo get_phrase('activity');?> 7</label>
            ...
            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group label-floating">
                    <label class="control-label"><?php echo get_phrase('activity');?> 8</label>
            ...
            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group label-floating">
                    <label class="control-label"><?php echo get_phrase('activity');?> 9</label>
            ...
            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group label-floating">
                    <label class="control-label"><?php echo get_phrase('activity');?> 10</label>
                    <input class="form-control" type="text" value="<?php echo $row['la10'];?>" name="la10">
                </div>
            </div>
            
            <div class="col col-sm-12 col-12" style="text-align: center;">
