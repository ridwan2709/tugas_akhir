                ...
                <div class="element-wrapper">
                  <div class="element-box-tp">
                    ...
                    <div class="col align-center mb-3">
                      <a class="animate__animated animate__bounceIn animate__infinite animate__slow btn btn-primary btn-rounded" href="<?= base_url() ?>"> Ada <?= 0 ?> berita/informasi belum dibaca</b></a>
                    </div>
                          ...
                          ?>
                            <tr>
                              <td class="text-left cell-with-media " style="background: #056ab3; color: #ffffff">
                                ...
                                <br><br>
                                <a style="color:#ffffff" class="delete" href="<?php echo base_url(); ?>admin/study_material/delete/<?php echo $row['document_id'] ?>/<?php echo $data; ?>"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a> &nbsp;
