	...
	<div class="col-sm-8">
		<div class="pipeline white lined-primary">
		  <div class="pipeline-header">
			...
			<div class="b-t padded-v-big"><a class="btn btn-rounded btn-sm btn-success save" href="<?php echo base_url();?>admin/view_report/update/<?php echo $row['report_code'];?>" style="color:white"><i class="os-icon picons-thin-icon-thin-0154_ok_successful_check"></i> <?php echo get_phrase('mark_solved');?></a></div>
			<?php endif;?>
			</div>
		</div>
			    ...
			    <h6 class="title"><?php echo get_phrase('student');?></h6>
                            ...
                            <div class="ui-block-content">
                                <div class="widget w-about" style="text-align:center">
                                    ...
                                    <h4><?php echo $this->crud_model->get_name('student', $row['student_id']);?><br> <small>Carnet: <?php echo $this->db->get_where('enroll', array('student_id' => $row['student_id']))->row()->roll;?>.</small></h4>
