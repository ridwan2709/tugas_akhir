        ...
        <div class="conty">
            <div class="content-i">
                <div class="content-box">
                    <div class="back">
                        <a href="<?php echo base_url(); ?>admin/meet_konseling/<?php echo base64_encode($row['class_id'] . "-" . $row['section_id'] . "-" . $row['subject_id']); ?>/"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a>
                    </div>
                    <div class="row">
    ...
    <script>
        ...
        var options = {
            userInfo: {
                ...
                displayName: '<?php echo $this->crud_model->get_name('admin', $this->session->userdata('login_user_id')); ?>',
                moderator: true,
            },
