    ...
    <div class="os-tabs-w menu-shad">
      <div class="os-tabs-controls">
        <ul class="navs navs-tabs upper">
          ...
          <li class="navs-item">
            <a class="navs-links active" href="<?php echo base_url(); ?>admin/email/"><i class="os-icon picons-thin-icon-thin-0315_email_mail_post_send"></i><span><?php echo get_phrase('email_settings'); ?></span></a>
          </li>
          <li class="navs-item">
              ...
              <div class="os-tabs-w">
                <div class="os-tabs-controls">
                  <ul class="navs navs-tabs">
                    ...
                    ?>
                      <li class="navs-item">
                        <a class="navs-link <?php if ($row['email_template_id'] == $current_email_template_id) echo 'active'; ?>" data-toggle="tab" href="#email<?php echo $row['email_template_id']; ?>"> <b>[</b><?php echo get_phrase($row['task']); ?><b>]</b></a>
                      </li>
                    <?php endforeach; ?>
                  </ul>
                </div>
              ...
              <div class="tab-content">
                <?php foreach ($email_templates as $row) : ?>
                  <div class="tab-pane <?php if ($row['email_template_id'] == $current_email_template_id) echo 'active'; ?>" id="email<?php echo $row['email_template_id']; ?>">
                    ...
                    <h5 class="form-header"><?php echo get_phrase($row['task']); ?></h5>
