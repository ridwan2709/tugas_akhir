                    ...
                    <div class="row">
                      ...
                      <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group label-floating">
                          ...
                          <input class="form-control" name="tempat_lahir" value="<?php echo $row['tempat_lahir']; ?>" type="text" required="">
                        </div>
                      </div>
                      <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group label-floating">
                      ...
                      <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group label-floating">
                          ...
                          <input class="form-control" name="sekolah" value="<?php echo $row['sekolah']; ?>" type="text">
                        </div>
                      </div>
                      <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group label-floating">
