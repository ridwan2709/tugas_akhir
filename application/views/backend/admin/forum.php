                            ...
                            <tr>
                              <td>
                                <?php if ($row['post_status'] == 0) : ?>
                                  <span class="status-pill blue" style="background-color: #0084ff;"></span><span><?php echo 'Hanya sesama mentor mapel'; ?></span>
                                <?php else : ?>
                                  <span class="status-pill green"></span> <span><?php echo 'Untuk semua anak'; ?></span>
                                <?php endif; ?>
                              </td>
                              <td><?php echo $row['title']; ?></td>
                              <td><span><?php echo $row['upload_date']; ?></span></td>
                              <td class="bolder">
                                <a style="color:grey;" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit'); ?>" href="<?php echo base_url(); ?>admin/edit_forum/<?php echo $row['post_code']; ?>"><i class="picons-thin-icon-thin-0001_compose_write_pencil_new"></i></a>
                                <a style="color:grey;" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('read_forum'); ?>" href="<?php echo base_url(); ?>admin/forumroom/<?php echo $row['post_code']; ?>"><i class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i></a>
                                <a style="color:grey;" class="danger" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete'); ?>" class="delete" href="<?php echo base_url(); ?>admin/forum/delete/<?php echo $row['post_code']; ?>/<?php echo $data; ?>/"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
                              </td>
                            </tr>
                          <?php endforeach; ?>
                        </tbody>
