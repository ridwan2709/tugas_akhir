                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="exam_title" placeholder="Jenis ujian">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type='text' class="datepicker-here" data-position="top left" data-language='en' name="exam_date" data-multiple-dates-separator="/"/ placeholder="Tanggal pelaksanaan ujian">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
