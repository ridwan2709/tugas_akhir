                          ...
                          <tr>
                            <td class="text-center">
                              ...
                              <?php if ($arrays[0] == "accountant") : ?>
                                <a class="btn nc btn-sm btn-rounded btn-info" href="#"><?php echo get_phrase('accountant'); ?></a>
                              <?php endif; ?>
                              <?php if ($arrays[0] == "librarian") : ?>
                                <a class="btn nc btn-sm btn-rounded btn-warning" href="#"><?php echo get_phrase('librarian'); ?></a>
                              <?php endif; ?>
                            </td>
                            <td class="text-center"><img alt="" src="<?php echo $this->crud_model->get_image_url($arrays[0], $arrays[1]); ?>" style="height: 25px; border-radius:50%" class="purple"> <?php echo $this->crud_model->get_name($arrays[0], $arrays[1]); ?></td>
