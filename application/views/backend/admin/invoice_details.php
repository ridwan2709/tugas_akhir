			...
			<div class="content-i">
				<div class="content-box">
					<div class="element-wrapper">
						<a href="<?php echo base_url();?>admin/students_payments/" class="btn btn-rounded btn-info"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i> <?php echo get_phrase('return');?></a>
						<button type="button" class="btn btn-rounded btn-success" onclick="Print('invoiceid')"><?php echo get_phrase('print_invoice');?></button>
						<div class="invoice-w" id="invoiceid">
							<div class="infos">
								...
								<div class="info-2" style="float:right"><br><br>
									...
									<div class="company-address text-dark">
										<?php echo NIS ;?> : <strong><?php echo $this->db->get_where('enroll', array('student_id' => $row['student_id']))->row()->roll;?></strong><br/>Kelas : 
									...
									<table class="table">
										...
										<tbody>
											<tr>
												...
												<td class="text-right uang"><?php echo $row['amount'];?></td>
											</tr>
										</tbody>
										<tfoot>
											<tr>
												<td><?php echo get_phrase('total');?></td>
												<td class="text-right uang" colspan="2"><?php echo $row['amount'];?></td>
											</tr>
										</tfoot>
									</table>
								</div>
							...
							<div class="invoice-footer">
								<div class="invoice-logo">
									<img alt="" src="<?php echo base_url();?>uploads/<?php echo $this->db->get_where('settings', array('type' => 'logo'))->row()->description;?>"><span><?php echo $this->db->get_where('settings', array('type' => 'system_name'))->row()->description;?></span>
								</div>
