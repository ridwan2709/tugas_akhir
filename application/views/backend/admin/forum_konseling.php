                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td class="bolder">
                              <a style="color:grey;" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit'); ?>" href="<?php echo base_url(); ?>admin/edit_forum_konseling/<?php echo $row['post_code']; ?>"><i class="picons-thin-icon-thin-0001_compose_write_pencil_new"></i></a>
                              <a style="color:grey;" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('read_forum'); ?>" href="<?php echo base_url(); ?>admin/forumroom_konseling/<?php echo $row['post_code']; ?>"><i class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i></a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="ui-block-content">
          <?php echo form_open(base_url() . 'admin/forum_konseling/create/' . $data, array('enctype' => 'multipart/form-data')); ?>
          <div class="row">
