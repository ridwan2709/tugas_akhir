                  ...
                  <div class="friend-item-content">
                      <div class="more">
                        ...
                        <ul class="more-dropdown">
                          ...
                          <li><a href="<?php echo base_url();?>admin/manage_classes/delete/<?php echo $class['class_id'];?>" class="delete"><?php echo get_phrase('delete');?></a></li>
                        </ul>
                      </div>
                      <div class="friend-avatar">
                        ...
                        <div class="author-content">
                          <a href="#" class="h5 author-name"><?php echo $class['name'];?></a>
