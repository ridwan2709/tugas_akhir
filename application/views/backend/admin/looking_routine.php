						...
						<div class="pi-settings os-dropdown-trigger">
						  ...
						  <div class="os-dropdown">
							...
							<ul>
							  ...
							  <li>
								<a class="delete" href="<?php echo base_url();?>admin/exam_routine/delete/<?php echo $row2['horario_id'];?>"><i class="os-icon picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i><span><?php echo get_phrase('delete');?></span></a>
							  </li>
							</ul>
						  </div>
						</div>
