<?php  $edit_data = $this->db->get_where('management' , array('id_management' => $param2))->result_array();
        foreach($edit_data as $row):
?>    
          <div class="modal-content">
            <a href="#" class="close icon-close" data-dismiss="modal" aria-label="Close"></a>
            <div class="modal-header">
              <h6 class="title">Ubah Data</h6>
            </div>
            <?php echo form_open(base_url() . 'admin/management/edit/'.$row['id_management'], array('enctype' => 'multipart/form-data')); ?>
