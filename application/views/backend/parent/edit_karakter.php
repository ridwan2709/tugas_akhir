    ...
    <div class="conty">
      <div class="os-tabs-w menu-shad">
        ...
        <ul class="navs navs-tabs upper">
          ...
          <li class="navs-item">
            <a class="navs-links" href="<?php echo base_url(); ?>parents/forum_konseling/"><i class="os-icon picons-thin-icon-thin-0281_chat_message_discussion_bubble_reply_conversation"></i><span>Forum Diskusi</span></a>
          </li>
          <li class="navs-item">
          ...
          <li class="navs-item">
            <a class="navs-links" href="<?php echo base_url(); ?>parents/karakter_building/"><i class="os-icon picons-thin-icon-thin-0591_presentation_video_play_beamer"></i><span><?php echo get_phrase('live'); ?></span></a>
          </li>
        </div>
      </div>
      <div class="content-i">
