        ...
        <div class="content-i">
            <div class="content-box">
                <div class="back" style="margin-top:-20px;margin-bottom:10px">
                    <a href="<?php echo base_url(); ?>parents/galeri/"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a>
                </div>
                        ...
                        ?>
                            <div class="col col-xl-3 col-lg-3 col-md-6 col-sm-6 portfolio-item filter-iht">
                                <div class="portfolio-wrap">
                                    ...
                                    <a href="<?php echo base_url(); ?>parents/galerifotos/delete/<?= $data['id_galeri']; ?>/<?= $data['id_kategori']; ?>" class="delete"><i style="font-size:20px;" class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete'); ?>"></i></a>
                                </div> -->
                                </div>
                            </div>
                        <?php
