					...
					<div class="ui-block">
						<div class="ui-block-title">
							...
							<?php if ($notifications->num_rows() > 0) : ?>
								<a class="delete btn btn-danger float-right" href="<?php echo base_url(); ?>parents/notification/delete_all/"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full"></i> Hapus semua notifikasi</a>
							<?php endif; ?>
						</div>
						<?php
						$this->db->order_by('id', 'desc');
								...
								<?php foreach ($notifications->result_array() as $notify) : ?>
									<li>
										...
										<div class="notification-event">
											...
											<a class="delete" href="<?php echo base_url(); ?>parents/notification/delete/<?php echo $notify['id']; ?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full"></i></a>
										</div>
									</li>
								<?php endforeach; ?>
							</ul>
