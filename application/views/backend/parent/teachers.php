        ...
        <div class="os-tabs-w">
          <div class="os-tabs-controls">
            <ul class="navs navs-tabs upper">
              ...
              ?>
                <li class="navs-item">
                  <a class="navs-links <?php if ($active1 == 1) echo 'active'; ?>" data-toggle="tab" href="#<?php echo $row['username']; ?>"><img alt="" src="<?php echo $this->crud_model->get_image_url('student', $row['student_id']); ?>" width="25px" class="purple" style="border-radius: 50%;margin-right:5px;"> <?php echo $this->crud_model->get_name('student', $row['student_id']); ?></a>
                </li>
              <?php endforeach; ?>
            </ul>
          </div>
                    ...
                    <div class="ui-block list">
                      <div class="birthday-item inline-items">
                        <div class="author-thumb">
                          <img src="<?php echo $this->crud_model->get_image_url('teacher', $row1['teacher_id']); ?>" class="avatars purple" style="border-radius: 50%;">
                        </div>
