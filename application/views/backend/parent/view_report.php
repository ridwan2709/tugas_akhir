									...
									?>
										<div class="element-box-w b-t">
											<div class="row m-t m-b">
												<div class="col-sm-10">
													<a href="#"><img alt="" src="<?php echo $this->crud_model->get_image_url($row2['sender_type'], $row2['sender_id']); ?>" width="30px" class="purple" style="border-radius:50%;margin-right:5px;"> <b><span class="infogi"><?php echo $this->crud_model->get_name($row2['sender_type'], $row2['sender_id']); ?></span></b></a>
	...
	$(document).ready(function() {
		$("#add").click(function() {
			...
			if (message != "" && report_code != "") {
				$.ajax({
					url: "<?php echo base_url(); ?>parents/student_report/response/",
					type: 'POST',
					data: {
						message: message,
