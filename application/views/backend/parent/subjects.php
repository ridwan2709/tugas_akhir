                      ...
                      <div class="top-header-thumb">
                        ...
                        <div class="top-header-author">
                          ...
                          <div class="author-content">
                            <a href="javascript:void(0);" class="h3 author-name"><?php echo get_phrase('academic'); ?></a>
                                ...
                                <div class="os-tabs-controls">
                                  <ul class="navs navs-tabs upper">
                                    ...
                                    foreach ($children_of_parent as $row) : ?>
                                      <li class="navs-item">
                                        <?php $active = $n++; ?>
                                        <a class="navs-links <?php if ($active == 1) echo 'active'; ?>" data-toggle="tab" href="#tab<?php echo $row['username']; ?>" aria-controls="#<?php echo $row['username']; ?>" data-toggle="tab"><img alt="" src="<?php echo $this->crud_model->get_image_url('student', $row['student_id']); ?>" width="25px" style="border-radius: 25px;margin-right:5px;"> <?php echo $this->crud_model->get_name('student', $row['student_id']); ?></a>
                                      </li>
                                    <?php endforeach; ?>
                                  </ul>
                                </div>
                        ...
                        <div class="container-fluid" style="background-color: #f2f4f8;">
                          <div class="tab-content">
                            ...
                            ?>
                              <?php $active = $n++; 
                              ?>
                              <div class="tab-pane <?php if ($active == 1) echo 'active'; ?>" id="tab<?php echo $row3['username']; ?>" role="tabpanel">
                                <div class="row">
                                  <?php
                                          ...
                                          <div class="friend-item-content">
                                            <div class="more">
                                              ...
                                              <ul class="more-dropdown">
                                                <li><a href="<?php echo base_url(); ?>parents/subject_dashboard/<?php echo base64_encode($class_id . "-" . $row2['subject_id'] . '-' . $row3['student_id']); ?>/" class="h5 author-name target-subjects" data-class="<?= $class_id ?>" data-subject="<?= $row2['subject_id'] ?>"><?php echo get_phrase('dashboard'); ?></a></li>
                                              </ul>
                                            </div>
                                            <div class="friend-avatar">
                                              ...
                                              <div class="author-content">
                                                <a href="<?php echo base_url(); ?>parents/subject_dashboard/<?php echo base64_encode($class_id . "-" . $row2['subject_id'] . '-' . $row3['student_id']); ?>/" class="h5 author-name target-subjects" data-class="<?= $class_id ?>" data-subject="<?= $row2['subject_id'] ?>"><?php echo $row2['name']; ?></a><br>
