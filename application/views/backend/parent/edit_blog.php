<?php $details = $this->db->get_where('tbl_tulisan', array('tulisan_id' => $id))->result_array();
          ...
          <div class="col-lg-12">
            ...
            <div class="element-wrapper">
              <div class="element-box lined-primary shadow">
                ...
                <?php echo form_open(base_url() . 'parents/blog/edit/' . $id, array('enctype' => 'multipart/form-data')); ?>
