<?php $reports = $this->db->get_where('laporan_konseling', array('report_code' => $code))->result_array();
		...
		<div class="conty">
			<div class="content-i">
				<div class="content-box">
					<div class="back">
						<a href="<?php echo base_url(); ?>parents/laporan/"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a>
					</div>
					<div class="row">
						...
						<div class="col-sm-8">
							...
							<div class="element-box shadow lined-success">
								...
								<?php if ($row['status'] == 1) : ?>
									<center>
										<div class="alert alert-success" role="alert"><strong><?php echo get_phrase('success'); ?></strong> <?php echo get_phrase('report_success'); ?></div>
									</center>
								<?php endif; ?>
								<div id="panel">
									<?php
									...
									?>
										<div class="element-box-w b-t">
											<div class="row m-t m-b">
												<div class="col-sm-10">
													<a href="javascript:void(0);"><img alt="" src="<?php echo $this->crud_model->get_image_url($row2['sender_type'], $row2['sender_id']); ?>" width="30px" style="border-radius: 50%; margin-right:5px;" class="purple"> <span class="infogi"><?php echo $this->crud_model->get_name($row2['sender_type'], $row2['sender_id']); ?></span></a>
						...
						<div class="col-sm-4">
							<div class="ui-block paddingtel lined-danger">
								...
								<div class="ui-block-content">
									<div class="widget w-about" style="text-align:center">
										<a href="javascript:void(0);" class="logo"><img src="<?php echo $this->crud_model->get_image_url('teacher', $row['teacher_id']); ?>" alt="Educaby" style="width:90px; border-radius: 50%;" class="purple"></a>
							...
							<div class="ui-block paddingtel lined-danger">
								...
								<div class="ui-block-content">
									<div class="widget w-about" style="text-align:center">
										<a href="javascript:void(0);" class="logo"><img src="<?php echo $this->crud_model->get_image_url('parent', $row['parent_id']); ?>" alt="Educaby" style="width:90px; border-radius: 50%" class="purple"></a>
	...
	$(document).ready(function() {
		$("#add").click(function() {
			...
			if (message != "" && report_code != "") {
				$.ajax({
					url: "<?php echo base_url(); ?>parents/create_report_message/",
					type: 'POST',
					data: {
						message: message,
