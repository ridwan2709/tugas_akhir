          ...
          <div class="row">
            <main class="col col-xl-6 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
              <div id="newsfeed-items-grid">
                <?php
                $db = $this->db->query("SELECT homework_id, wall_type,publish_date FROM homework WHERE class_id = $ex[0] AND subject_id = $ex[1] UNION SELECT document_id,wall_type,publish_date FROM document WHERE class_id = $ex[0] AND subject_id = $ex[1] UNION SELECT online_exam_id,wall_type,publish_date FROM online_exam WHERE class_id = $ex[0] AND subject_id = $ex[1] UNION SELECT post_id,wall_type,publish_date FROM forum WHERE class_id = $ex[0] AND subject_id = $ex[1] ORDER BY publish_date DESC LIMIT 10");
                if ($db->num_rows() > 0) :
                        ...
                        <article class="hentry post thumb-full-width">
                          ...
                          <div class="edu-posts cta-with-media verde">
                            <div class="cta-content">
                              ...
                              <div class="grado">
                                <?php echo $this->db->get_where('class', array('class_id' => $ex[0]))->row()->name; ?>
                              </div>
                              ...
                              <a href="<?php echo base_url(); ?>parents/homeworkroom/<?php echo $this->db->get_where('homework', array('homework_id' => $wall['homework_id']))->row()->homework_code; ?>/<?php echo $ex[2]; ?>/"><button class="btn btn-rounded btn-posts"><i class="picons-thin-icon-thin-0100_to_do_list_reminder_done"></i> <?php echo get_phrase('view_homework'); ?></button></a>
                            </div>
                          </div>
                        ...
                        <article class="hentry post thumb-full-width">
                          ...
                          <div class="edu-posts cta-with-media verde">
                            <div class="cta-content">
                              ...
                              <div class="deadtime">
                                <span><?php echo get_phrase('duration'); ?> :</span><i class="picons-thin-icon-thin-0026_time_watch_clock"></i>
                                <?php
                                $minutes = number_format($this->db->get_where('online_exam', array('online_exam_id' => $wall['homework_id']))->row()->duration);
                                echo $minutes; ?>
                                <?php echo get_phrase('minutes'); ?>
                              </div>
                        ...
                        <article class="hentry post thumb-full-width">
                          ...
                          <div class="edu-posts cta-with-media verde">
                            <div class="cta-content">
                              ...
                              <a href="<?php echo base_url(); ?>parents/forumroom/<?php echo $this->db->get_where('forum', array('post_id' => $wall['homework_id']))->row()->post_code; ?>/<?php echo $ex[2]; ?>/"><button class="btn btn-rounded btn-posts"><i class="picons-thin-icon-thin-0014_notebook_paper_todo"></i> <?php echo get_phrase('view_forum'); ?></button></a>
                            </div>
                          </div>
                          <div class="control-block-button post-control-button">
            ...
            <div class="col col-xl-3 order-xl-1 col-lg-6 order-lg-2 col-md-6 col-sm-12 col-12">
              <div class="crumina-sticky-sidebar">
                <div class="sidebar__inner">
                  <div class="ui-block">
                    ...
                    <div class="ui-block-content">
                      <div class="widget w-about">
                        ...
                        <?php $tch = $this->db->get_where('subject', array('subject_id' => $ex[1]))->row()->teacher_id; ?>
                        <div class="post__author author vcard inline-items" style="text-align: center; margin-bottom: 0;">
                  ...
                  <div class="ui-block">
                    <div class="ui-block-title">
                      <h6 class="title"><?php echo get_phrase('suject_activity'); ?></h6>
                    </div>
                    <?php
                    $this->db->order_by('id', 'desc');
                    $this->db->group_by('type');
                    $notifications = $this->db->get_where('notification', array('class_id' => $ex[0], 'subject_id' => $ex[1], 'year' => $running_year));
                ...
                <div class="sidebar__inner">
                  ...
                  <div class="ui-block paddingtel">
                    ...
                    <div class="ui-block-content">
                      <div style="margin-bottom:10px">
                        <span class="subjectCounter"><?php echo $this->academic_model->countOnlineExams($ex[0], $section_id, $ex[1]); ?></span>
                        <span class="counterText h6"><?php echo get_phrase('online_exams'); ?>.</span>
                      </div>
                      <div style="margin-bottom:10px">
                        <span class="subjectCounter"><?php echo $this->academic_model->countHomeworks($ex[0], $section_id, $ex[1]); ?></span>
                        <span class="counterText h6"><?php echo get_phrase('homework'); ?>.</span>
                      </div>
                      <div style="margin-bottom:10px">
                        <span class="subjectCounter"><?php echo $this->academic_model->countForums($ex[0], $section_id, $ex[1]); ?></span>
                        <span class="counterText h6"><?php echo get_phrase('forums'); ?>.</span>
                      </div>
                      <div style="margin-bottom:10px">
                        <span class="subjectCounter"><?php echo $this->academic_model->countMaterial($ex[0], $section_id, $ex[1]); ?></span>
                        <span class="counterText h6"><?php echo get_phrase('study_material'); ?>.</span>
                      </div>
                      <div style="margin-bottom:10px">
                        <span class="subjectCounter"><?php echo $this->academic_model->countLive($ex[0], $section_id, $ex[1]); ?></span>
                  ...
                  <div class="ui-block paddingtel">
                    ...
                    <ul class="widget w-friend-pages-added notification-list friend-requests">
                      <?php $students   =   $this->db->get_where('enroll', array('class_id' => $ex[0], 'year' => $running_year))->result_array();
                      foreach ($students as $row2) : ?>
                        <li class="inline-items">
                          ...
                          <div class="notification-event">
                            ...
                            <span class="chat-message-item">NIS : <?php echo $this->db->get_where('enroll', array('student_id' => $row2['student_id']))->row()->roll; ?></span>
                          </div>
                        </li>
                      <?php endforeach; ?>
                    </ul>
