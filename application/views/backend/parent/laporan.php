    ...
    <div class="os-tabs-w menu-shad">
      <div class="os-tabs-controls">
        <ul class="navs navs-tabs upper">
          <li class="navs-item">
            <a class="navs-links" href="<?php echo base_url(); ?>parents/konseling/"><i class="os-icon picons-thin-icon-thin-0281_chat_message_discussion_bubble_reply_conversation"></i><span>Forum Diskusi</span></a>
          </li>
          <li class="navs-item">
            <a class="navs-links active" href="<?php echo base_url(); ?>parents/laporan/"><i class="os-icon picons-thin-icon-thin-0389_gavel_hammer_law_judge_court"></i><span><?php echo get_phrase('reports'); ?></span></a>
          </li>
          <li class="navs-item">
                ...
                <div class="element-box-tp">
                  <div class="table-responsive">
                    <table class="table table-padded">
                      ...
                      <tbody>
                        <?php $reports = $this->db->get_where('laporan_konseling', array('parent_id' => $this->session->userdata('login_user_id')))->result_array();
                        foreach ($reports as $row) :
                        ?>
                          <tr>
                            <td><img alt="" src="<?php echo $this->crud_model->get_image_url('teacher', $row['teacher_id']); ?>" width="25px" class="purple" style="border-radius: 50%;margin-right:5px;"> <?php echo $this->crud_model->get_name('teacher', $row['teacher_id']); ?></td>
                            <td><a href="<?php echo base_url(); ?>parents/lihat_laporan/<?php echo $row['report_code']; ?>" style="color:#000;"><?php echo $row['title']; ?></a></td>
                            ...
                            <td class="row-actions">
                              <a class="btn btn-rounded btn-sm btn-primary" style="color:white" href="<?php echo base_url(); ?>parents/lihat_laporan/<?php echo $row['report_code']; ?>"><i class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i> <?php echo get_phrase('view'); ?></< /a>
                            </td>
                          </tr>
                        <?php endforeach; ?>
                      </tbody>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="ui-block-title" style="background-color:#00579c">
          <h6 class="title" style="color:white">Buat Laporan</h6>
        </div>
        <div class="ui-block-content">
          <?php echo form_open(base_url() . 'parents/proses_laporan/create/', array('enctype' => 'multipart/form-data')); ?>
          <div class="row">
