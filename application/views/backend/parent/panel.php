          ...
          <main class="col col-xl-6 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
            ...
            if ($checkNews != $checkNewsNew) { ?>
              <div class="col align-center mb-3">
                <a class="animate__animated animate__bounceIn animate__infinite animate__slow btn btn-primary btn-rounded" href="<?= base_url() . 'parents/readNews/' . $checkNews ?>">Ada <?= $cekCount ?> berita/informasi belum dibaca</a>
              </div>
            <?php } else {
              //tidak ditampilkan
            }
                                  ...
                                  <div class="skills-item">
                                    <div class="skills-item-info">
                                      <span class="skills-item-title">
                                        <span class="radio">
                                          <h6><label>
                                              <input type="radio" id="answer" name="answer<?php echo $poll_code; ?>" value="<?php echo $array[$i]; ?>"><span class="circle" style="border: 3px solid;"></span><span class="check"></span>
                                              <?php echo $array[$i]; ?>
                                            </label></h6>
                                        </span>
                                      </span>
                  ...
                  <ul class="widget w-friend-pages-added notification-list friend-requests">
                    ...
                    ?>
                        <li class="inline-items">
                          <a href="<?php echo base_url(); ?>parents/group/group_message_read/<?php echo $row['group_message_thread_code']; ?>/">
                          ...
                          <center>
                            <div class="widget w-birthday-alert">
                              ...
                              <div class="content">
                                ...
                                <a href="<?php echo base_url(); ?>parents/birthdays/" class="text-white">
...
<script>
  ...
  function vote(poll_code) {
    ...
    if (answer != "" && poll_code != "") {
      $.ajax({
        url: "<?php echo base_url(); ?>parents/polls/response/",
        type: 'POST',
        data: {
          answer: answer,
          poll_code: poll_code
