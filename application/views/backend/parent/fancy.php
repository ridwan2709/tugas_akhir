...
$fancy_cl_id = $fc_ex[0];
$fancy_section_id = $this->db->get_where('enroll', array('student_id' => $fc_ex[2]))->row()->section_id;
?>
        ...
        <div class="page-title">
            <div class="fancy-selector-w">
                <div class="fancy-selector-current">
                    <div class="fs-img">
                        <img alt="" src="<?php echo base_url(); ?>uploads/subject_icon/<?php echo $this->db->get_where('subject', array('subject_id' => $fc_ex[1]))->row()->icon; ?>">
                    </div>
                    <div class="fs-main-info">
                        <div class="fs-name"><?php echo $this->db->get_where('subject', array('subject_id' => $fc_ex[1]))->row()->name; ?></div>
                    </div>
                ...
                <div class="fancy-selector-options active">
                    ...
                    ?>
                        <a href="<?php echo base_url(); ?>parents/subject_dashboard/<?php echo base64_encode($fancy_cl_id . '-' . $fancy_row2['subject_id'] . '-' . $fc_ex[2]); ?>/">
        ...
        <div class="control-block">
            <div class="control-icon more has-items">
                ...
                <div class="more-dropdown more-with-triangle triangle-top-center">
                            ...
                            ?>
                                ...
                                <li class="message-unread">
                                    ...
                                    <div class="notification-event">
                                        <a href="<?php echo base_url(); ?>parents/message/message_read/<?php echo $fancy_rows['message_thread_code']; ?>/" class="h6 notification-friend"><?php echo $this->crud_model->get_name($fancy_user_to_show_type, $fancy_user_to_show_id); ?></a>
                    ...
                    <a href="<?php echo base_url(); ?>parents/message/" class="view-all bg-info"><?php echo get_phrase('view_all_messages'); ?></a>
                </div>
            </div>
            <div class="control-icon more has-items">
                            ...
                            ?>
                                <li>
                                    ...
                                    <div class="float-right">
                                        <a class="delete" style="margin-right: 15px;" href="<?php echo base_url(); ?>parents/notification/delete/<?php echo $fancy_notify['id']; ?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" style="color:red !important; font-size:18px"></i></a>
                                    </div>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
                    <a href="<?php echo base_url(); ?>parents/notifications/" class="view-all bg-info"><?php echo get_phrase('view_all_notifications'); ?></a>
                </div>
            </div>
            <div class="author-page author vcard inline-items more">
                <div class="author-thumb">
                    <img alt="author" src="<?php echo $this->crud_model->get_image_url('parent', $this->session->userdata('login_user_id')); ?>" class="avatar bg-white" width="32px">
                ...
                <a href="#" class="author-name fn">
                    <div class="author-title">
                        <?php echo $this->crud_model->get_name('parent', $this->session->userdata('login_user_id')); ?> <svg class="olymp-dropdown-arrow-icon">
                ...
                <ul class="notification-list chat-message">
                    ...
                    ?>
                        ...
                        <li class="message-unread">
                            ...
                            <div class="notification-event">
                                <a href="<?php echo base_url(); ?>parents/message/message_read/<?php echo $row1['message_thread_code']; ?>/" class="h6 notification-friend"><?php echo $this->crud_model->get_name($fancy_user_to_show_type, $fancy_user_to_show_id); ?></a>
                                <span class="chat-message-item" style="text-align: justify;"><?php if ($rw->sender == $fancy_current_user) echo get_phrase('you') . ": " . substr($rw->message, 0, 90) . '...';
                                                                                                else echo substr($rw->message, 0, 90); ?>...</span>
                                <span class="notification-date"><time class="entry-date updated"><?php echo $rw->timestamp; ?></time></span>
                            </div>
                    ...
                    ?>
                        <li>
                            ...
                            <div class="notification-event">
                                ...
                                <span class="notification-date"><time class="entry-date updated"><?php echo $fancy_notify['date']; ?> <?php echo get_phrase('at'); ?> <?php echo $fancy_notify['time']; ?></time></span>
                      <a class="delete" style="margin-right: 15px;" href="<?php echo base_url();?>parents/notification/delete/<?php echo $fancy_notify['id'];?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" style="color:#528dbd !important; font-size:14px"></i></a>
                            </div>
                        </li>
                    <?php endforeach; ?>
                </ul>
