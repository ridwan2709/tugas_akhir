...
<div class="back" style="margin-top:-20px;margin-bottom:10px">		
 <a href="<?php echo base_url();?>parents/online_exams/<?php echo base64_encode($online_exam_info->class_id.'-'.$online_exam_info->subject_id.'-'.$student_id);?>/"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a>	
</div>
<?php
...
<element class="col-sm-6 col-aligncenter">
  <div class="pipeline white lined-danger">            
    ...
    <?php if ($question_type == 'multiple_choice'):
      ...
      ?>
      <i>Jawaban Anak : <br/><strong><?php echo rtrim(trim($r), ',');?></strong></i>
      <br><br><br>
      <?php
    ...
    <?php elseif($question_type == 'fill_in_the_blanks'):
      ...
      <i>Jawaban Anak : <br/><strong><?php echo $submitted_answer;?></strong></i><br/><br/><br/>
