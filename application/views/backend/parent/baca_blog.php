  ...
  <div class="header-spacer"></div>
    <div class="os-tabs-w menu-shad">
		<div class="os-tabs-controls">
          ...
          <li class="navs-item">
            <a class="navs-links" href="<?php echo base_url();?>parents/news/"><i class="os-icon picons-thin-icon-thin-0010_newspaper_reading_news"></i>  <span>Berita</span></a>
        </li>
				<li class="navs-item">
	...
	<a href="<?php echo base_url();?>parents/blog/"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a>	
	</div>	
        <div class="row">
                  ...
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="more">
                      ...
                      <ul class="more-dropdown">
                        <li><a href="<?php echo base_url();?>parents/edit_blog/<?php echo $row['tulisan_id'];?>/"><?php echo get_phrase('edit');?></a></li>
                        <li><a href="<?php echo base_url();?>parents/blog/delete/<?php echo $row['tulisan_id'];?>/"><?php echo get_phrase('delete');?></a></li>
                      </ul>
                    </div>                
                  </div>                
