    ...
    <div class="os-tabs-w menu-shad">
      <div class="os-tabs-controls">
        <ul class="navs navs-tabs">
          <li class="navs-item">
            <a class="navs-links active" href="<?php echo base_url(); ?>parents/noticeboard/"><i class="os-icon picons-thin-icon-thin-0010_newspaper_reading_news"></i> <span>Berita</span></a>
          </li>
          <li class="navs-item">
      ...
      <div class="conta iner">
        ...
        if ($checkNews != $checkNewsNew) { ?>
          <div class="col align-center mb-3">
            <a class="animate__animated animate__bounceIn animate__infinite animate__slow btn btn-primary btn-rounded" href="<?= base_url() . 'parents/readNews/' . $checkNews ?>">Ada <?= $cekCount ?> berita/informasi belum dibaca</b></a>
          </div>
        <?php } else {
          //tidak ditampilkan
        }
