					...
					<div class="row">
						<div class="col-sm-8">
							<div class="pipeline white lined-primary shadow">
								...
								<?php else : ?>
									<div class="alert alert-danger" role="alert"><strong><?php echo get_phrase('fail'); ?>. </strong><?php echo get_phrase('no_delivered'); ?></div>
								<?php endif; ?>
							</div>
						</div>
									...
									<table class="table table-lightbor table-lightfont">
										...
										<tr>
											...
											<td>
												...
												<?php endif; ?>
												<?php if ($query->num_rows() > 0) : ?>
													<a class="btn btn-rounded btn-sm btn-primary" style="color:white"><?php $mark = $this->db->get_where('deliveries', array('homework_code' => $homework_code, 'student_id' => $student_id))->row()->mark;
																														if ($mark > 0) echo $mark;
																														else echo get_phrase('waiting_mark'); ?></a>
												<?php endif; ?>
											</td>
										</tr>
										<tr>
