        ...
        <table class="table table-bordered">
          ...
          ?>
            <tr>
              ...
              <td><img src="<?php echo $this->crud_model->get_image_url($user_type, $user_id); ?>" class="img-circle purple" width="35" style="border-radius: 50%;"> &nbsp;&nbsp; <?php echo $this->db->get_where($user_type, array($user_type . '_id' => $user_id))->row()->first_name . " " . $this->db->get_where($user_type, array($user_type . '_id' => $user_id))->row()->last_name; ?></td>
            </tr>
          <?php endfor ?>
        </table>
      </div>
