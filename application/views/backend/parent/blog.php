    ...
    <div class="os-tabs-w menu-shad">
      <div class="os-tabs-controls">
        <ul class="navs navs-tabs">
          ...
          <li class="navs-item">
            <a class="navs-links" href="<?php echo base_url(); ?>parents/galeri/"><i class="picons-thin-icon-thin-0618_album_picture_image_photo"></i> <span>Galery</span></a>
          </li>
          <li class="navs-item">
            <a class="navs-links active" href="<?php echo base_url(); ?>parents/blog/"><i class="picons-thin-icon-thin-0075_document_file_paper_text_article_blog_template"></i> <span>Blog</span></a>
          </li>
        </ul>
      </div>
    </div>
                  ...
                  <div class="table-responsive">
                    <table class="table table-padded">
                      ...
                      <tbody>
                        ...
                        $blog = $this->db->get_where('tbl_tulisan')->result_array();
                        foreach ($blog as $b) :
                        ?>
                          <tr>
                            ...
                            <td class="bolder">
                              ...
                              $author = $this->crud_model->get_name('parent', $this->session->userdata('login_user_id'));
                              if ($b['tulisan_pengguna_id'] == $id && $b['tulisan_author'] == $author) { ?>
                                <a style="color:grey;" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit'); ?>" href="<?php echo base_url(); ?>parents/edit_blog/<?php echo $b['tulisan_id']; ?>"><i class="picons-thin-icon-thin-0001_compose_write_pencil_new"></i></a>
                                <a style="color:grey;" data-toggle="tooltip" data-placement="top" data-original-title="Baca Blog" href="<?php echo base_url(); ?>parents/baca_blog/<?php echo $b['tulisan_id']; ?>"><i class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i></a>
                                <a style="color:grey;" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete'); ?>" class="danger danger" href="<?php echo base_url(); ?>parents/blog/delete/<?php echo $b['tulisan_id']; ?>/<?php echo $data; ?>/" ><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
                              <?php } else { ?>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="color:grey;" data-toggle="tooltip" data-placement="top" data-original-title="Baca Blog" href="<?php echo base_url(); ?>parents/baca_blog/<?php echo $b['tulisan_id']; ?>"><i class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i></a>
                              <?php } ?>
                            </td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="ui-block-content">
          <?php echo form_open(base_url() . 'parents/blog/create/', array('enctype' => 'multipart/form-data')); ?>
          <div class="row">
