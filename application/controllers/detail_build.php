<?php $details = $this->db->get_where('build', array('code' => $code))->result_array();
    ...
    <div class="header-spacer"></div>
		...
		<div class="pipeline white lined-primary">
		  <div class="pipeline-header">
			...
			<?php if($row['status'] == 0):?><br><br>
			 <div class="b-t padded-v-big"><a class="btn btn-rounded btn-sm btn-success save"  href="<?php echo base_url();?>director/create_report/update/<?php echo $row['code'];?>" style="color:white"><i class="os-icon picons-thin-icon-thin-0154_ok_successful_check"></i> <?php echo get_phrase('mark_solved');?></a></div>
			<?php endif;?>
		</div>
		...
		<div class="element-box-w b-t">
            <div class="row m-t m-b">
			  <div class="col-sm-10">
				  <a href="javascript:void(0);"><img alt="" src="<?php echo $this->crud_model->get_image_url($row2['sender_type'], $row2['sender_id']);?>" width="30px" style="border-radius:20px;margin-right:5px;"> <span class="h6"><?php echo $this->crud_model->get_name($row2['sender_type'], $row2['sender_id']);?></span></a>
	    ...
	    <div class="ui-block paddingtel lined-danger">
	        ...
	        <div class="ui-block-title">
	        	...
	        	<?php $user1 = $row['user_id']; $user = explode("-", $user1);?>
                            <div class="ui-block-content">
                                <div class="widget w-about" style="text-align:center">
                                    <a href="javascript:void(0);" class="logo"><img src="<?php echo $this->crud_model->get_image_url($user[0], $user[1]);?>" alt="Educaby" style="width:90px;"></a>
